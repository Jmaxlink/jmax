.class final Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nBridgeRouter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BridgeRouter.kt\ncom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8\n+ 2 ApplicationCallPipeline.kt\nio/ktor/server/application/ApplicationCallPipelineKt\n+ 3 ApplicationReceiveFunctions.kt\nio/ktor/server/request/ApplicationReceiveFunctionsKt\n+ 4 TypeInfoJvm.kt\nio/ktor/util/reflect/TypeInfoJvmKt\n+ 5 ApplicationResponseFunctions.kt\nio/ktor/server/response/ApplicationResponseFunctionsKt\n*L\n1#1,349:1\n75#2:350\n75#2:356\n68#3:351\n69#3:355\n17#4,3:352\n17#4,3:359\n26#5,2:357\n29#5,2:362\n*S KotlinDebug\n*F\n+ 1 BridgeRouter.kt\ncom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8\n*L\n89#1:350\n91#1:356\n89#1:351\n89#1:355\n89#1:352,3\n91#1:359,3\n91#1:357,2\n91#1:362,2\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.hermesandroid.bridge.server.BridgeRouterKt$configureRouting$1$8"
    f = "BridgeRouter.kt"
    i = {
        0x0
    }
...
.method constructor <init>(Lkotlin/coroutines/Continuation;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;",
            ">;)V"
        }
    .end annotation
...
.method public final invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;

    invoke-direct {v0, p3}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;-><init>(Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->L$0:Ljava/lang/Object;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 87
    iget v1, p0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->label:I
    ...
    .local v0, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    ...
    .end local v0    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .end local v1    # "$i$f$respondWithType":I
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object v1, p0

    .local v1, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .restart local p1    # "$result":Ljava/lang/Object;
    const/4 v2, 0x0

    .local v2, "$i$f$receive":I
    iget-object v3, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    ...
    .restart local v1    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->L$0:Ljava/lang/Object;
    ...
    const-class v6, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;
    ...
    const-class v8, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;
    ...
    iput-object v3, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->L$0:Ljava/lang/Object;

    const/4 v7, 0x1

    iput v7, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->label:I
    ...
    .local v2, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    :goto_0
    if-eqz p1, :cond_3

    .line 89
    .end local v4    # "$i$f$receive":I
    check-cast p1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;

    .line 90
    .local p1, "req":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;
    ...
    invoke-virtual {p1}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;->getKey()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/hermesandroid/bridge/executor/ActionExecutor;->pressKey(Ljava/lang/String;)Lcom/hermesandroid/bridge/model/ActionResult;
    ...
    iput-object v8, v2, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->L$0:Ljava/lang/Object;

    const/4 v8, 0x2

    iput v8, v2, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;->label:I
    ...
    .line 363
    .end local v2    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .end local v4    # "$i$f$respondWithType":I
    .restart local v0    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .local v1, "$i$f$respondWithType":I
    .local p1, "$result":Ljava/lang/Object;
    :goto_1
    nop
    ...
    .end local p1    # "$result":Ljava/lang/Object;
    .local v1, "$result":Ljava/lang/Object;
    .restart local v2    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8;
    .local v4, "$i$f$receive":I
    :cond_3
    ...
    const-class v3, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$8$PressKeyRequest;
