.class final Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nBridgeRouter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 BridgeRouter.kt\ncom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5\n+ 2 ApplicationCallPipeline.kt\nio/ktor/server/application/ApplicationCallPipelineKt\n+ 3 ApplicationReceiveFunctions.kt\nio/ktor/server/request/ApplicationReceiveFunctionsKt\n+ 4 TypeInfoJvm.kt\nio/ktor/util/reflect/TypeInfoJvmKt\n+ 5 ApplicationResponseFunctions.kt\nio/ktor/server/response/ApplicationResponseFunctionsKt\n*L\n1#1,349:1\n75#2:350\n75#2:356\n68#3:351\n69#3:355\n17#4,3:352\n17#4,3:359\n26#5,2:357\n29#5,2:362\n*S KotlinDebug\n*F\n+ 1 BridgeRouter.kt\ncom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5\n*L\n64#1:350\n68#1:356\n64#1:351\n64#1:355\n64#1:352,3\n68#1:359,3\n68#1:357,2\n68#1:362,2\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/coroutines/jvm/internal/DebugMetadata;
    c = "com.hermesandroid.bridge.server.BridgeRouterKt$configureRouting$1$5"
    f = "BridgeRouter.kt"
    i = {
        0x0,
        0x1
...
.method constructor <init>(Lkotlin/coroutines/Continuation;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lkotlin/coroutines/Continuation<",
            "-",
            "Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;",
            ">;)V"
        }
    .end annotation
...
.method public final invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    new-instance v0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;

    invoke-direct {v0, p3}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;-><init>(Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 62
    iget v1, p0, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->label:I
    ...
    .local v0, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    ...
    .end local v0    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .end local v1    # "$i$f$respondWithType":I
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object v1, p0

    .local v1, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v3, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;
    ...
    .end local v1    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .end local v3    # "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    .end local p1    # "$result":Ljava/lang/Object;
    :pswitch_2
    move-object v1, p0

    .restart local v1    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .restart local p1    # "$result":Ljava/lang/Object;
    const/4 v3, 0x0

    .local v3, "$i$f$receive":I
    iget-object v4, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;
    ...
    const-class v7, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;
    ...
    const-class v9, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;
    ...
    iput-object v3, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;

    const/4 v8, 0x1

    iput v8, v1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->label:I
    ...
    .local v3, "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .local v4, "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    :goto_0
    if-eqz p1, :cond_4
    ...
    check-cast p1, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;

    .line 65
    .local p1, "req":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;
    ...
    new-instance v6, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$result$1;

    invoke-direct {v6, p1, v2}, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$result$1;-><init>(Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object v4, v3, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;

    const/4 v8, 0x2

    iput v8, v3, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->label:I
    ...
    .end local p1    # "req":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;
    if-ne p1, v0, :cond_1
    ...
    iput-object v2, v3, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->L$0:Ljava/lang/Object;

    const/4 v2, 0x3

    iput v2, v3, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;->label:I
    ...
    .line 363
    .end local v3    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .end local v5    # "$i$f$respondWithType":I
    .restart local v0    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .local v1, "$i$f$respondWithType":I
    .local p1, "$result":Ljava/lang/Object;
    :goto_2
    nop
    ...
    .end local p1    # "$result":Ljava/lang/Object;
    .local v1, "$result":Ljava/lang/Object;
    .restart local v3    # "this":Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5;
    .local v4, "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    .local v5, "$i$f$receive":I
    :cond_4
    ...
    const-class v2, Lcom/hermesandroid/bridge/server/BridgeRouterKt$configureRouting$1$5$TypeRequest;
