...
.method public static final getJavaConstructor(Lkotlin/reflect/KFunction;)Ljava/lang/reflect/Constructor;
    .locals 3
    .param p0, "$this$javaConstructor"    # Lkotlin/reflect/KFunction;
...
.method public static final getJavaField(Lkotlin/reflect/KProperty;)Ljava/lang/reflect/Field;
    .locals 1
    .param p0, "$this$javaField"    # Lkotlin/reflect/KProperty;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KProperty<",
...
.method public static final getJavaGetter(Lkotlin/reflect/KProperty;)Ljava/lang/reflect/Method;
    .locals 1
    .param p0, "$this$javaGetter"    # Lkotlin/reflect/KProperty;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KProperty<",
...
.method public static final getJavaMethod(Lkotlin/reflect/KFunction;)Ljava/lang/reflect/Method;
    .locals 3
    .param p0, "$this$javaMethod"    # Lkotlin/reflect/KFunction;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KFunction<",
...
.method public static final getJavaSetter(Lkotlin/reflect/KMutableProperty;)Ljava/lang/reflect/Method;
    .locals 1
    .param p0, "$this$javaSetter"    # Lkotlin/reflect/KMutableProperty;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lkotlin/reflect/KMutableProperty<",
...
.method private static final getKPackage(Ljava/lang/reflect/Member;)Lkotlin/reflect/KDeclarationContainer;
    .locals 4
    .param p0, "$this$getKPackage"    # Ljava/lang/reflect/Member;
    ...
    invoke-direct {v0, v1}, Lkotlin/reflect/jvm/internal/KPackageImpl;-><init>(Ljava/lang/Class;)V
...
.method public static final getKotlinFunction(Ljava/lang/reflect/Constructor;)Lkotlin/reflect/KFunction;
    .locals 7
    .param p0, "$this$kotlinFunction"    # Ljava/lang/reflect/Constructor;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            "Ljava/lang/Object;",
    ...
    .line 146
    .local v5, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$5":I
    invoke-static {v4}, Lkotlin/reflect/jvm/ReflectJvmMapping;->getJavaConstructor(Lkotlin/reflect/KFunction;)Ljava/lang/reflect/Constructor;
    ...
    .end local v5    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$5":I
    if-eqz v4, :cond_0
...
.method public static final getKotlinFunction(Ljava/lang/reflect/Method;)Lkotlin/reflect/KFunction;
    .locals 13
    .param p0, "$this$kotlinFunction"    # Ljava/lang/reflect/Method;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/reflect/Method;",
    ...
    .line 121
    .local v0, "kotlinPackage":Lkotlin/reflect/KDeclarationContainer;
    if-eqz v0, :cond_4
    ...
    instance-of v9, v8, Lkotlin/reflect/KFunction;
    ...
    .local v6, "it":Lkotlin/reflect/KFunction;
    const/4 v7, 0x0

    .line 122
    .local v7, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$1":I
    invoke-static {v6}, Lkotlin/reflect/jvm/ReflectJvmMapping;->getJavaMethod(Lkotlin/reflect/KFunction;)Ljava/lang/reflect/Method;
    ...
    .line 175
    .end local v6    # "it":Lkotlin/reflect/KFunction;
    .end local v7    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$1":I
    if-eqz v6, :cond_2
    ...
    .line 127
    .local v3, "companion":Lkotlin/reflect/KClass;
    if-eqz v3, :cond_8

    .line 128
    invoke-static {v3}, Lkotlin/reflect/full/KClasses;->getFunctions(Lkotlin/reflect/KClass;)Ljava/util/Collection;
    ...
    .line 129
    .local v9, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$2":I
    invoke-static {v8}, Lkotlin/reflect/jvm/ReflectJvmMapping;->getJavaMethod(Lkotlin/reflect/KFunction;)Ljava/lang/reflect/Method;
    ...
    .end local v9    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$2":I
    ...
    .line 179
    .local v1, "it":Lkotlin/reflect/KFunction;
    const/4 v2, 0x0

    .line 132
    .local v2, "$i$a$-let-ReflectJvmMapping$kotlinFunction$3":I
    return-object v1

    .line 136
    .end local v0    # "kotlinPackage":Lkotlin/reflect/KDeclarationContainer;
    .end local v1    # "it":Lkotlin/reflect/KFunction;
    .end local v2    # "$i$a$-let-ReflectJvmMapping$kotlinFunction$3":I
    .end local v3    # "companion":Lkotlin/reflect/KClass;
    :cond_8
    invoke-virtual {p0}, Ljava/lang/reflect/Method;->getDeclaringClass()Ljava/lang/Class;
    ...
    .local v5, "it":Lkotlin/reflect/KFunction;
    const/4 v6, 0x0

    .line 136
    .local v6, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$4":I
    ...
    .line 180
    .end local v5    # "it":Lkotlin/reflect/KFunction;
    .end local v6    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinFunction$4":I
    if-eqz v5, :cond_9
...
.method public static final getKotlinProperty(Ljava/lang/reflect/Field;)Lkotlin/reflect/KProperty;
    .locals 10
    .param p0, "$this$kotlinProperty"    # Ljava/lang/reflect/Field;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/reflect/Field;",
    ...
    .local v8, "element$iv$iv":Ljava/lang/Object;
    instance-of v9, v8, Lkotlin/reflect/KProperty;
    ...
    .local v6, "it":Lkotlin/reflect/KProperty;
    const/4 v7, 0x0

    .line 99
    .local v7, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinProperty$1":I
    ...
    .line 160
    .end local v6    # "it":Lkotlin/reflect/KProperty;
    .end local v7    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinProperty$1":I
    if-eqz v6, :cond_3
    ...
    .local v6, "it":Lkotlin/reflect/KProperty1;
    const/4 v7, 0x0

    .line 102
    .local v7, "$i$a$-firstOrNull-ReflectJvmMapping$kotlinProperty$2":I
    move-object v8, v6
    ...
    .line 162
    .end local v6    # "it":Lkotlin/reflect/KProperty1;
    .end local v7    # "$i$a$-firstOrNull-ReflectJvmMapping$kotlinProperty$2":I
    if-eqz v6, :cond_6
