...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lio/ktor/http/content/OutputStreamContent$writeTo$2;
    .local p1, "$result":Ljava/lang/Object;
    const/4 v1, 0x0

    .local v1, "$i$a$-use-OutputStreamContent$writeTo$2$1":I
    iget-object v3, v0, Lio/ktor/http/content/OutputStreamContent$writeTo$2;->L$0:Ljava/lang/Object;
    ...
    .line 27
    .end local v1    # "$i$a$-use-OutputStreamContent$writeTo$2$1":I
    :catchall_0
    move-exception v1
    ...
    .line 24
    .end local v0    # "this":Lio/ktor/http/content/OutputStreamContent$writeTo$2;
    ...
    .line 27
    .local v1, "this":Lio/ktor/http/content/OutputStreamContent$writeTo$2;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v3, v1, Lio/ktor/http/content/OutputStreamContent$writeTo$2;->$channel:Lio/ktor/utils/io/ByteWriteChannel;

    const/4 v4, 0x1

    invoke-static {v3, v2, v4, v2}, Lio/ktor/utils/io/jvm/javaio/BlockingKt;->toOutputStream$default(Lio/ktor/utils/io/ByteWriteChannel;Lkotlinx/coroutines/Job;ILjava/lang/Object;)Ljava/io/OutputStream;

    move-result-object v3

    check-cast v3, Ljava/io/Closeable;

    iget-object v5, v1, Lio/ktor/http/content/OutputStreamContent$writeTo$2;->this$0:Lio/ktor/http/content/OutputStreamContent;
    ...
    .line 28
    .local v7, "$i$a$-use-OutputStreamContent$writeTo$2$1":I
    invoke-static {v5}, Lio/ktor/http/content/OutputStreamContent;->access$getBody$p(Lio/ktor/http/content/OutputStreamContent;)Lkotlin/jvm/functions/Function2;

    move-result-object v5

    iput-object v3, v1, Lio/ktor/http/content/OutputStreamContent$writeTo$2;->L$0:Ljava/lang/Object;

    iput v4, v1, Lio/ktor/http/content/OutputStreamContent$writeTo$2;->label:I
    ...
    .line 29
    .end local v7    # "$i$a$-use-OutputStreamContent$writeTo$2$1":I
    .restart local v0    # "this":Lio/ktor/http/content/OutputStreamContent$writeTo$2;
    .local v1, "$i$a$-use-OutputStreamContent$writeTo$2$1":I
    :goto_0
    :try_start_2
    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    ...
    .end local v1    # "this":Lio/ktor/http/content/OutputStreamContent$writeTo$2;
    .end local p1    # "$result":Ljava/lang/Object;
    :goto_1
    :try_start_3
    throw v1
