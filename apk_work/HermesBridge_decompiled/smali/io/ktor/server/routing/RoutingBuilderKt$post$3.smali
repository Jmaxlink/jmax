...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lio/ktor/server/routing/RoutingBuilderKt;->postTypedPath(Lio/ktor/server/routing/Route;Ljava/lang/String;Lkotlin/jvm/functions/Function3;)Lio/ktor/server/routing/Route;
.end annotation
...
.method public constructor <init>(Lkotlin/jvm/functions/Function3;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->$body:Lkotlin/jvm/functions/Function3;
...
.method public final invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->$body:Lkotlin/jvm/functions/Function3;

    invoke-direct {v0, v1, p3}, Lio/ktor/server/routing/RoutingBuilderKt$post$3;-><init>(Lkotlin/jvm/functions/Function3;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->invoke(Lio/ktor/util/pipeline/PipelineContext;Lkotlin/Unit;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, v1, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->label:I
    ...
    .local v0, "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    ...
    .end local v0    # "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    .end local v2    # "$result":Ljava/lang/Object;
    :pswitch_1
    move-object/from16 v2, p0

    .local v2, "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    ...
    iget-object v9, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$1:Ljava/lang/Object;

    check-cast v9, Lio/ktor/util/pipeline/PipelineContext;

    iget-object v10, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    ...
    .restart local v2    # "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    move-object/from16 v7, p1

    .restart local v7    # "$result":Ljava/lang/Object;
    iget-object v8, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;
    ...
    .line 162
    .local v9, "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    iget-object v10, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->$body:Lkotlin/jvm/functions/Function3;

    move-object v8, v9

    .end local v9    # "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    ...
    iput-object v10, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;

    iput-object v9, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$1:Ljava/lang/Object;

    const/4 v14, 0x1

    iput v14, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->label:I
    ...
    iput-object v5, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;

    iput-object v5, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$1:Ljava/lang/Object;

    const/4 v3, 0x2

    iput v3, v2, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->label:I
    ...
    .line 163
    .end local v7    # "$result":Ljava/lang/Object;
    .restart local v0    # "this":Lio/ktor/server/routing/RoutingBuilderKt$post$3;
    .local v2, "$result":Ljava/lang/Object;
    :goto_1
...
.method public final invokeSuspend$$forInline(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->L$0:Ljava/lang/Object;

    check-cast v0, Lio/ktor/util/pipeline/PipelineContext;

    .line 162
    .local v0, "$this$post":Lio/ktor/util/pipeline/PipelineContext;
    iget-object v1, p0, Lio/ktor/server/routing/RoutingBuilderKt$post$3;->$body:Lkotlin/jvm/functions/Function3;
