...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    invoke-direct {v0, v1, p2}, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;-><init>(Lio/ktor/websocket/WebSocketWriter;Lkotlin/coroutines/Continuation;)V
...
.method public final invoke(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;

    sget-object v1, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;

    invoke-virtual {v0, v1}, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v0, "this":Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;
    ...
    .local v2, "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    iget-object v3, v0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$1:Ljava/lang/Object;

    .local v3, "instance$iv":Ljava/lang/Object;
    iget-object v4, v0, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$0:Ljava/lang/Object;
    ...
    .line 184
    .end local v2    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    :catchall_0
    move-exception v2
    ...
    .line 39
    .end local v0    # "this":Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;
    ...
    .line 40
    .local v1, "this":Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;
    .restart local p1    # "$result":Ljava/lang/Object;
    iget-object v2, v1, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->this$0:Lio/ktor/websocket/WebSocketWriter;

    invoke-virtual {v2}, Lio/ktor/websocket/WebSocketWriter;->getPool()Lio/ktor/utils/io/pool/ObjectPool;
    ...
    .local v6, "it":Ljava/nio/ByteBuffer;
    const/4 v7, 0x0

    .line 40
    .local v7, "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    iput-object v4, v1, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$0:Ljava/lang/Object;

    iput-object v5, v1, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->L$1:Ljava/lang/Object;

    const/4 v8, 0x1

    iput v8, v1, Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;->label:I

    invoke-static {v2, v6, v1}, Lio/ktor/websocket/WebSocketWriter;->access$writeLoop(Lio/ktor/websocket/WebSocketWriter;Ljava/nio/ByteBuffer;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v2
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .end local v6    # "it":Ljava/nio/ByteBuffer;
    if-ne v2, v0, :cond_0
    ...
    .end local v7    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    .restart local v0    # "this":Lio/ktor/websocket/WebSocketWriter$writeLoopJob$1;
    .local v1, "$i$f$useInstance":I
    .restart local v2    # "$i$a$-useInstance-WebSocketWriter$writeLoopJob$1$1":I
    .local v3, "instance$iv":Ljava/lang/Object;
    :goto_0
    :try_start_2
