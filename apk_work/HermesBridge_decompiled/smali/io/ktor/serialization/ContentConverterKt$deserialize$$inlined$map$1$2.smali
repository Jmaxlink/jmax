...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v0, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->result:Ljava/lang/Object;
    ...
    .line 0
    iget v2, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->label:I
    ...
    .local v2, "$i$a$-map-ContentConverterKt$deserialize$result$1":I
    iget-object v3, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->L$0:Ljava/lang/Object;
    ...
    .end local v2    # "$i$a$-map-ContentConverterKt$deserialize$result$1":I
    .end local p1    # "$i$a$-unsafeTransform-FlowKt__TransformKt$map$1":I
    :pswitch_2
    invoke-static {v0}, Lkotlin/ResultKt;->throwOnFailure(Ljava/lang/Object;)V
    ...
    .line 53
    .local v2, "this":Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;
    .local p1, "value":Ljava/lang/Object;
    iget-object v3, v2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;->$this_unsafeFlow:Lkotlinx/coroutines/flow/FlowCollector;
    ...
    .local p1, "converter":Lio/ktor/serialization/ContentConverter;
    const/4 v5, 0x0

    .line 224
    .local v5, "$i$a$-map-ContentConverterKt$deserialize$result$1":I
    iget-object v6, v2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;->$charset$inlined:Ljava/nio/charset/Charset;

    iget-object v7, v2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;->$typeInfo$inlined:Lio/ktor/util/reflect/TypeInfo;

    iget-object v8, v2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;->$body$inlined:Lio/ktor/utils/io/ByteReadChannel;

    iput-object v3, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->L$0:Ljava/lang/Object;

    const/4 v9, 0x1

    iput v9, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->label:I

    invoke-interface {p1, v6, v7, v8, p2}, Lio/ktor/serialization/ContentConverter;->deserialize(Ljava/nio/charset/Charset;Lio/ktor/util/reflect/TypeInfo;Lio/ktor/utils/io/ByteReadChannel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object p1

    .end local v2    # "this":Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;
    .end local p1    # "converter":Lio/ktor/serialization/ContentConverter;
    if-ne p1, v1, :cond_1
    ...
    .end local v5    # "$i$a$-map-ContentConverterKt$deserialize$result$1":I
    .local v2, "$i$a$-map-ContentConverterKt$deserialize$result$1":I
    :goto_1
    nop
    ...
    iput-object v2, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->L$0:Ljava/lang/Object;

    const/4 v2, 0x2

    iput v2, p2, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2$1;->label:I
