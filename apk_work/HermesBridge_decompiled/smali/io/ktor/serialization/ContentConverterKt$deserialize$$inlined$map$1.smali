...
.method public collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v3, p0, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1;->$this_unsafeTransform$inlined:Lkotlinx/coroutines/flow/Flow;

    new-instance v4, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;

    iget-object v5, p0, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1;->$charset$inlined:Ljava/nio/charset/Charset;

    iget-object v6, p0, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1;->$typeInfo$inlined:Lio/ktor/util/reflect/TypeInfo;

    iget-object v7, p0, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1;->$body$inlined:Lio/ktor/utils/io/ByteReadChannel;

    invoke-direct {v4, v0, v5, v6, v7}, Lio/ktor/serialization/ContentConverterKt$deserialize$$inlined$map$1$2;-><init>(Lkotlinx/coroutines/flow/FlowCollector;Ljava/nio/charset/Charset;Lio/ktor/util/reflect/TypeInfo;Lio/ktor/utils/io/ByteReadChannel;)V
