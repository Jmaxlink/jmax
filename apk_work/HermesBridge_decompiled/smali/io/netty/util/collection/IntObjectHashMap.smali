...
.method public constructor <init>()V
    ...
    .line 72
    .local p0, "this":Lio/netty/util/collection/IntObjectHashMap;, "Lio/netty/util/collection/IntObjectHashMap<TV;>;"
    const/16 v0, 0x8
...
.method public constructor <init>(IF)V
    ...
    iput v1, p0, Lio/netty/util/collection/IntObjectHashMap;->mask:I

    .line 93
    new-array v1, v0, [I

    iput-object v1, p0, Lio/netty/util/collection/IntObjectHashMap;->keys:[I
    ...
    iput-object v1, p0, Lio/netty/util/collection/IntObjectHashMap;->values:[Ljava/lang/Object;

    .line 99
    invoke-direct {p0, v0}, Lio/netty/util/collection/IntObjectHashMap;->calcMaxSize(I)I
...
.method static synthetic access$300(Lio/netty/util/collection/IntObjectHashMap;)I
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/IntObjectHashMap;
...
.method static synthetic access$500(Lio/netty/util/collection/IntObjectHashMap;)Ljava/util/Set;
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/IntObjectHashMap;
...
.method static synthetic access$600(Lio/netty/util/collection/IntObjectHashMap;)[Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/IntObjectHashMap;
...
.method static synthetic access$700(Lio/netty/util/collection/IntObjectHashMap;I)Z
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/IntObjectHashMap;
    .param p1, "x1"    # I
...
.method static synthetic access$800(Lio/netty/util/collection/IntObjectHashMap;)[I
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/IntObjectHashMap;
...
.method private calcMaxSize(I)I
    ...
    iget v2, p0, Lio/netty/util/collection/IntObjectHashMap;->loadFactor:F
...
.method private hashIndex(I)I
    ...
    iget v1, p0, Lio/netty/util/collection/IntObjectHashMap;->mask:I
...
.method private rehash(I)V
    ...
    iput v3, p0, Lio/netty/util/collection/IntObjectHashMap;->maxSize:I

    .line 461
    add-int/lit8 v3, p1, -0x1

    iput v3, p0, Lio/netty/util/collection/IntObjectHashMap;->mask:I
    ...
    .local v6, "index":I
    :goto_1
    iget-object v7, p0, Lio/netty/util/collection/IntObjectHashMap;->values:[Ljava/lang/Object;
    ...
    .line 480
    :cond_0
    invoke-direct {p0, v6}, Lio/netty/util/collection/IntObjectHashMap;->probeNext(I)I
...
.method private removeAt(I)Z
    ...
    .line 426
    :cond_1
    iget-object v8, p0, Lio/netty/util/collection/IntObjectHashMap;->keys:[I

    aput v6, v8, v0

    .line 427
    iget-object v8, p0, Lio/netty/util/collection/IntObjectHashMap;->values:[Ljava/lang/Object;
...
.method public containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v0}, Lio/netty/util/collection/IntObjectHashMap;->containsKey(I)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 280
    .local v1, "other":Lio/netty/util/collection/IntObjectMap;
    iget v3, p0, Lio/netty/util/collection/IntObjectHashMap;->size:I
    ...
    .line 287
    .local v5, "key":I
    invoke-interface {v1, v5}, Lio/netty/util/collection/IntObjectMap;->get(I)Ljava/lang/Object;

    move-result-object v6

    .line 288
    .local v6, "otherValue":Ljava/lang/Object;
    sget-object v7, Lio/netty/util/collection/IntObjectHashMap;->NULL_VALUE:Ljava/lang/Object;
...
.method public get(I)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lio/netty/util/collection/IntObjectHashMap;->toExternal(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public put(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 135
    invoke-static {v2}, Lio/netty/util/collection/IntObjectHashMap;->toExternal(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public put(Ljava/lang/Integer;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p2}, Lio/netty/util/collection/IntObjectHashMap;->put(ILjava/lang/Object;)Ljava/lang/Object;
...
.method public putAll(Ljava/util/Map;)V
    ...
    check-cast v0, Lio/netty/util/collection/IntObjectHashMap;

    .line 152
    .local v0, "source":Lio/netty/util/collection/IntObjectHashMap;, "Lio/netty/util/collection/IntObjectHashMap<TV;>;"
    const/4 v1, 0x0

    .local v1, "i":I
    :goto_0
    iget-object v2, v0, Lio/netty/util/collection/IntObjectHashMap;->values:[Ljava/lang/Object;
    ...
    .line 155
    iget-object v3, v0, Lio/netty/util/collection/IntObjectHashMap;->keys:[I

    aget v3, v3, v1

    invoke-virtual {p0, v3, v2}, Lio/netty/util/collection/IntObjectHashMap;->put(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 162
    .end local v0    # "source":Lio/netty/util/collection/IntObjectHashMap;, "Lio/netty/util/collection/IntObjectHashMap<TV;>;"
    :cond_2
    ...
    .line 163
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<+Ljava/lang/Integer;+TV;>;"
    ...
    invoke-virtual {p0, v2, v3}, Lio/netty/util/collection/IntObjectHashMap;->put(Ljava/lang/Integer;Ljava/lang/Object;)Ljava/lang/Object;

    .line 164
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<+Ljava/lang/Integer;+TV;>;"
    goto :goto_1
...
.method public remove(I)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lio/netty/util/collection/IntObjectHashMap;->removeAt(I)Z
...
.method public remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lio/netty/util/collection/IntObjectHashMap;->remove(I)Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lio/netty/util/collection/IntObjectHashMap;->keyToString(I)Ljava/lang/String;
