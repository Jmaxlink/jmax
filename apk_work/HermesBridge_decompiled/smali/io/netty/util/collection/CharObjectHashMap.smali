...
.method public constructor <init>()V
    ...
    .line 72
    .local p0, "this":Lio/netty/util/collection/CharObjectHashMap;, "Lio/netty/util/collection/CharObjectHashMap<TV;>;"
    const/16 v0, 0x8
...
.method public constructor <init>(IF)V
    ...
    iput v1, p0, Lio/netty/util/collection/CharObjectHashMap;->mask:I

    .line 93
    new-array v1, v0, [C

    iput-object v1, p0, Lio/netty/util/collection/CharObjectHashMap;->keys:[C
    ...
    iput-object v1, p0, Lio/netty/util/collection/CharObjectHashMap;->values:[Ljava/lang/Object;

    .line 99
    invoke-direct {p0, v0}, Lio/netty/util/collection/CharObjectHashMap;->calcMaxSize(I)I
...
.method static synthetic access$300(Lio/netty/util/collection/CharObjectHashMap;)I
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/CharObjectHashMap;
...
.method static synthetic access$500(Lio/netty/util/collection/CharObjectHashMap;)Ljava/util/Set;
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/CharObjectHashMap;
...
.method static synthetic access$600(Lio/netty/util/collection/CharObjectHashMap;)[Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/CharObjectHashMap;
...
.method static synthetic access$700(Lio/netty/util/collection/CharObjectHashMap;I)Z
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/CharObjectHashMap;
    .param p1, "x1"    # I
...
.method static synthetic access$800(Lio/netty/util/collection/CharObjectHashMap;)[C
    .locals 1
    .param p0, "x0"    # Lio/netty/util/collection/CharObjectHashMap;
...
.method private calcMaxSize(I)I
    ...
    iget v2, p0, Lio/netty/util/collection/CharObjectHashMap;->loadFactor:F
...
.method private hashIndex(C)I
    ...
    iget v1, p0, Lio/netty/util/collection/CharObjectHashMap;->mask:I
...
.method private rehash(I)V
    ...
    iput v3, p0, Lio/netty/util/collection/CharObjectHashMap;->maxSize:I

    .line 461
    add-int/lit8 v3, p1, -0x1

    iput v3, p0, Lio/netty/util/collection/CharObjectHashMap;->mask:I
    ...
    .local v6, "index":I
    :goto_1
    iget-object v7, p0, Lio/netty/util/collection/CharObjectHashMap;->values:[Ljava/lang/Object;
    ...
    .line 480
    :cond_0
    invoke-direct {p0, v6}, Lio/netty/util/collection/CharObjectHashMap;->probeNext(I)I
...
.method private removeAt(I)Z
    ...
    .line 426
    :cond_1
    iget-object v8, p0, Lio/netty/util/collection/CharObjectHashMap;->keys:[C

    aput-char v6, v8, v0

    .line 427
    iget-object v8, p0, Lio/netty/util/collection/CharObjectHashMap;->values:[Ljava/lang/Object;
...
.method public containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v0}, Lio/netty/util/collection/CharObjectHashMap;->containsKey(C)Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Lio/netty/util/collection/CharObjectMap;

    .line 280
    .local v1, "other":Lio/netty/util/collection/CharObjectMap;
    iget v3, p0, Lio/netty/util/collection/CharObjectHashMap;->size:I

    invoke-interface {v1}, Lio/netty/util/collection/CharObjectMap;->size()I
    ...
    .line 287
    .local v5, "key":C
    invoke-interface {v1, v5}, Lio/netty/util/collection/CharObjectMap;->get(C)Ljava/lang/Object;

    move-result-object v6

    .line 288
    .local v6, "otherValue":Ljava/lang/Object;
    sget-object v7, Lio/netty/util/collection/CharObjectHashMap;->NULL_VALUE:Ljava/lang/Object;
...
.method public get(C)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lio/netty/util/collection/CharObjectHashMap;->toExternal(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public put(CLjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 135
    invoke-static {v2}, Lio/netty/util/collection/CharObjectHashMap;->toExternal(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public put(Ljava/lang/Character;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p2}, Lio/netty/util/collection/CharObjectHashMap;->put(CLjava/lang/Object;)Ljava/lang/Object;
...
.method public putAll(Ljava/util/Map;)V
    ...
    .line 148
    .local p0, "this":Lio/netty/util/collection/CharObjectHashMap;, "Lio/netty/util/collection/CharObjectHashMap<TV;>;"
    .local p1, "sourceMap":Ljava/util/Map;, "Ljava/util/Map<+Ljava/lang/Character;+TV;>;"
    ...
    check-cast v0, Lio/netty/util/collection/CharObjectHashMap;

    .line 152
    .local v0, "source":Lio/netty/util/collection/CharObjectHashMap;, "Lio/netty/util/collection/CharObjectHashMap<TV;>;"
    const/4 v1, 0x0

    .local v1, "i":I
    :goto_0
    iget-object v2, v0, Lio/netty/util/collection/CharObjectHashMap;->values:[Ljava/lang/Object;
    ...
    .line 155
    iget-object v3, v0, Lio/netty/util/collection/CharObjectHashMap;->keys:[C

    aget-char v3, v3, v1

    invoke-virtual {p0, v3, v2}, Lio/netty/util/collection/CharObjectHashMap;->put(CLjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 162
    .end local v0    # "source":Lio/netty/util/collection/CharObjectHashMap;, "Lio/netty/util/collection/CharObjectHashMap<TV;>;"
    :cond_2
    ...
    .line 163
    .local v1, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<+Ljava/lang/Character;+TV;>;"
    ...
    invoke-virtual {p0, v2, v3}, Lio/netty/util/collection/CharObjectHashMap;->put(Ljava/lang/Character;Ljava/lang/Object;)Ljava/lang/Object;

    .line 164
    .end local v1    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<+Ljava/lang/Character;+TV;>;"
    goto :goto_1
...
.method public remove(C)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lio/netty/util/collection/CharObjectHashMap;->removeAt(I)Z
...
.method public remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lio/netty/util/collection/CharObjectHashMap;->remove(C)Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lio/netty/util/collection/CharObjectHashMap;->keyToString(C)Ljava/lang/String;
