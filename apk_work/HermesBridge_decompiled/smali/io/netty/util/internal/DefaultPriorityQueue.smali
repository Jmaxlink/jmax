...
.method private bubbleDown(ILio/netty/util/internal/PriorityQueueNode;)V
    ...
    .line 250
    .local v2, "child":Lio/netty/util/internal/PriorityQueueNode;, "TT;"
    add-int/lit8 v3, v1, 0x1

    .line 251
    .local v3, "rightChild":I
    iget v4, p0, Lio/netty/util/internal/DefaultPriorityQueue;->size:I

    if-ge v3, v4, :cond_0

    iget-object v4, p0, Lio/netty/util/internal/DefaultPriorityQueue;->comparator:Ljava/util/Comparator;

    iget-object v5, p0, Lio/netty/util/internal/DefaultPriorityQueue;->queue:[Lio/netty/util/internal/PriorityQueueNode;
    ...
    invoke-interface {v4, p2, v2}, Ljava/util/Comparator;->compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    .line 262
    invoke-interface {v2, p0, p1}, Lio/netty/util/internal/PriorityQueueNode;->priorityQueueIndex(Lio/netty/util/internal/DefaultPriorityQueue;I)V
    ...
    .end local v2    # "child":Lio/netty/util/internal/PriorityQueueNode;, "TT;"
    .end local v3    # "rightChild":I
    goto :goto_0
...
.method public poll()Lio/netty/util/internal/PriorityQueueNode;
    ...
    .line 114
    .local v3, "last":Lio/netty/util/internal/PriorityQueueNode;, "TT;"
    iget-object v4, p0, Lio/netty/util/internal/DefaultPriorityQueue;->queue:[Lio/netty/util/internal/PriorityQueueNode;
    ...
    .line 116
    invoke-direct {p0, v2, v3}, Lio/netty/util/internal/DefaultPriorityQueue;->bubbleDown(ILio/netty/util/internal/PriorityQueueNode;)V
...
.method public removeTyped(Lio/netty/util/internal/PriorityQueueNode;)Z
    ...
    .line 155
    .local v1, "moved":Lio/netty/util/internal/PriorityQueueNode;, "TT;"
    iget-object v4, p0, Lio/netty/util/internal/DefaultPriorityQueue;->queue:[Lio/netty/util/internal/PriorityQueueNode;
    ...
    invoke-interface {v3, p1, v1}, Ljava/util/Comparator;->compare(Ljava/lang/Object;Ljava/lang/Object;)I
    ...
    .line 160
    invoke-direct {p0, v0, v1}, Lio/netty/util/internal/DefaultPriorityQueue;->bubbleDown(ILio/netty/util/internal/PriorityQueueNode;)V

    goto :goto_0

    .line 162
    :cond_2
    invoke-direct {p0, v0, v1}, Lio/netty/util/internal/DefaultPriorityQueue;->bubbleUp(ILio/netty/util/internal/PriorityQueueNode;)V
    ...
    .line 149
    .end local v1    # "moved":Lio/netty/util/internal/PriorityQueueNode;, "TT;"
    :cond_3
    :goto_1
    iget-object v1, p0, Lio/netty/util/internal/DefaultPriorityQueue;->queue:[Lio/netty/util/internal/PriorityQueueNode;
