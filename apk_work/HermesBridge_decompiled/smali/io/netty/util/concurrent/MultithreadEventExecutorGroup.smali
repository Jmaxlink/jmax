...
.method protected varargs constructor <init>(ILjava/util/concurrent/Executor;Lio/netty/util/concurrent/EventExecutorChooserFactory;[Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v4, p0, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->children:[Lio/netty/util/concurrent/EventExecutor;
    ...
    invoke-interface {v5}, Lio/netty/util/concurrent/EventExecutor;->shutdownGracefully()Lio/netty/util/concurrent/Future;
    ...
    .line 98
    .local v5, "e":Lio/netty/util/concurrent/EventExecutor;
    :goto_3
    :try_start_1
    invoke-interface {v5}, Lio/netty/util/concurrent/EventExecutor;->isTerminated()Z
    ...
    invoke-interface {v5, v2, v3, v6}, Lio/netty/util/concurrent/EventExecutor;->awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    :try_end_1
    ...
    .line 95
    .end local v5    # "e":Lio/netty/util/concurrent/EventExecutor;
    add-int/lit8 v4, v4, 0x1

    goto :goto_2

    .line 101
    .restart local v5    # "e":Lio/netty/util/concurrent/EventExecutor;
    :catch_0
    move-exception v2
    ...
    invoke-interface {v6, v2, v3, v7}, Lio/netty/util/concurrent/EventExecutor;->awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    :try_end_3
    ...
    invoke-interface {p3, v0}, Lio/netty/util/concurrent/EventExecutorChooserFactory;->newChooser([Lio/netty/util/concurrent/EventExecutor;)Lio/netty/util/concurrent/EventExecutorChooserFactory$EventExecutorChooser;

    move-result-object v0

    iput-object v0, p0, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->chooser:Lio/netty/util/concurrent/EventExecutorChooserFactory$EventExecutorChooser;

    .line 113
    new-instance v0, Lio/netty/util/concurrent/MultithreadEventExecutorGroup$1;

    invoke-direct {v0, p0}, Lio/netty/util/concurrent/MultithreadEventExecutorGroup$1;-><init>(Lio/netty/util/concurrent/MultithreadEventExecutorGroup;)V

    .line 122
    .local v0, "terminationListener":Lio/netty/util/concurrent/FutureListener;, "Lio/netty/util/concurrent/FutureListener<Ljava/lang/Object;>;"
    ...
    invoke-interface {v5, v0}, Lio/netty/util/concurrent/Future;->addListener(Lio/netty/util/concurrent/GenericFutureListener;)Lio/netty/util/concurrent/Future;
    ...
    .line 127
    .local v1, "childrenSet":Ljava/util/Set;, "Ljava/util/Set<Lio/netty/util/concurrent/EventExecutor;>;"
    iget-object v2, p0, Lio/netty/util/concurrent/MultithreadEventExecutorGroup;->children:[Lio/netty/util/concurrent/EventExecutor;
