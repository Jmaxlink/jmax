...
.method public execute(Ljava/lang/Runnable;)V
    ...
    .line 115
    invoke-virtual {p0}, Lio/netty/util/concurrent/AbstractEventExecutorGroup;->next()Lio/netty/util/concurrent/EventExecutor;

    move-result-object v0

    invoke-interface {v0, p1}, Lio/netty/util/concurrent/EventExecutor;->execute(Ljava/lang/Runnable;)V
...
.method public invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lio/netty/util/concurrent/EventExecutor;->invokeAll(Ljava/util/Collection;)Ljava/util/List;
...
.method public invokeAll(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/util/List;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lio/netty/util/concurrent/EventExecutor;->invokeAll(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/util/List;
...
.method public invokeAny(Ljava/util/Collection;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lio/netty/util/concurrent/EventExecutor;->invokeAny(Ljava/util/Collection;)Ljava/lang/Object;
...
.method public invokeAny(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lio/netty/util/concurrent/EventExecutor;->invokeAny(Ljava/util/Collection;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lio/netty/util/concurrent/EventExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
...
.method public schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lio/netty/util/concurrent/EventExecutor;->schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
...
.method public scheduleAtFixedRate(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
    ...
    invoke-interface/range {v0 .. v6}, Lio/netty/util/concurrent/EventExecutor;->scheduleAtFixedRate(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
...
.method public scheduleWithFixedDelay(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
    ...
    invoke-interface/range {v0 .. v6}, Lio/netty/util/concurrent/EventExecutor;->scheduleWithFixedDelay(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;
...
.method public shutdownGracefully()Lio/netty/util/concurrent/Future;
    ...
    invoke-virtual/range {v0 .. v5}, Lio/netty/util/concurrent/AbstractEventExecutorGroup;->shutdownGracefully(JJLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/Future;
...
.method public submit(Ljava/lang/Runnable;)Lio/netty/util/concurrent/Future;
    ...
    invoke-interface {v0, p1}, Lio/netty/util/concurrent/EventExecutor;->submit(Ljava/lang/Runnable;)Lio/netty/util/concurrent/Future;
...
.method public submit(Ljava/lang/Runnable;Ljava/lang/Object;)Lio/netty/util/concurrent/Future;
    ...
    invoke-interface {v0, p1, p2}, Lio/netty/util/concurrent/EventExecutor;->submit(Ljava/lang/Runnable;Ljava/lang/Object;)Lio/netty/util/concurrent/Future;
...
.method public submit(Ljava/util/concurrent/Callable;)Lio/netty/util/concurrent/Future;
    ...
    invoke-interface {v0, p1}, Lio/netty/util/concurrent/EventExecutor;->submit(Ljava/util/concurrent/Callable;)Lio/netty/util/concurrent/Future;
