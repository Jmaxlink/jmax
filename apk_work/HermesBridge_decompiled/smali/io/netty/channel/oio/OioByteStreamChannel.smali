...
.method protected final activate(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 81
    iget-boolean v0, p0, Lio/netty/channel/oio/OioByteStreamChannel;->readWhenInactive:Z

    if-eqz v0, :cond_0

    .line 82
    invoke-virtual {p0}, Lio/netty/channel/oio/OioByteStreamChannel;->eventLoop()Lio/netty/channel/EventLoop;

    move-result-object v0

    iget-object v1, p0, Lio/netty/channel/oio/OioByteStreamChannel;->readTask:Ljava/lang/Runnable;
    ...
    iput-boolean v0, p0, Lio/netty/channel/oio/OioByteStreamChannel;->readWhenInactive:Z
