...
.method constructor <init>(Lio/netty/channel/RecvByteBufAllocator$ExtendedHandle;)V
    ...
    .line 26
    new-instance v0, Lio/netty/channel/unix/PreferredDirectByteBufAllocator;

    invoke-direct {v0}, Lio/netty/channel/unix/PreferredDirectByteBufAllocator;-><init>()V

    iput-object v0, p0, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->preferredDirectByteBufAllocator:Lio/netty/channel/unix/PreferredDirectByteBufAllocator;

    .line 28
    new-instance v0, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle$1;

    invoke-direct {v0, p0}, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle$1;-><init>(Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;)V

    iput-object v0, p0, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->defaultMaybeMoreDataSupplier:Lio/netty/util/UncheckedBooleanSupplier;
...
.method public final allocate(Lio/netty/buffer/ByteBufAllocator;)Lio/netty/buffer/ByteBuf;
    ...
    .line 75
    invoke-virtual {p0}, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->delegate()Lio/netty/channel/RecvByteBufAllocator$Handle;

    move-result-object v0

    iget-object v1, p0, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->preferredDirectByteBufAllocator:Lio/netty/channel/unix/PreferredDirectByteBufAllocator;
...
.method maybeMoreDataToRead()Z
    ...
    invoke-virtual {p0}, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->lastBytesRead()I
    ...
    invoke-virtual {p0}, Lio/netty/channel/epoll/EpollRecvByteAllocatorHandle;->attemptedBytesRead()I
