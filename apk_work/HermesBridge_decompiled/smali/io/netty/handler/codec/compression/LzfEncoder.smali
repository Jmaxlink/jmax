...
.method protected encode(Lio/netty/channel/ChannelHandlerContext;Lio/netty/buffer/ByteBuf;Lio/netty/buffer/ByteBuf;)V
    ...
    invoke-virtual {v7, v10, v0, v11, v9}, Lio/netty/buffer/ByteBuf;->getBytes(I[BII)Lio/netty/buffer/ByteBuf;
    ...
    .line 164
    .local v14, "maxOutputLength":I
    invoke-virtual {v8, v14}, Lio/netty/buffer/ByteBuf;->ensureWritable(I)Lio/netty/buffer/ByteBuf;

    .line 167
    invoke-virtual/range {p3 .. p3}, Lio/netty/buffer/ByteBuf;->hasArray()Z
    ...
    .end local v4    # "outputPtr":I
    .restart local v16    # "outputPtr":I
    move/from16 v1, v16

    .end local v16    # "outputPtr":I
    .restart local v1    # "outputPtr":I
    invoke-static {v12, v13, v9, v15, v1}, Lio/netty/handler/codec/compression/LzfEncoder;->encodeNonCompress([BII[BI)I
    ...
    invoke-virtual {v8, v2}, Lio/netty/buffer/ByteBuf;->writerIndex(I)Lio/netty/buffer/ByteBuf;

    goto :goto_3

    .line 187
    :cond_3
    invoke-virtual {v8, v15, v11, v0}, Lio/netty/buffer/ByteBuf;->writeBytes([BII)Lio/netty/buffer/ByteBuf;
    ...
    .line 193
    iget-object v2, v6, Lio/netty/handler/codec/compression/LzfEncoder;->recycler:Lcom/ning/compress/BufferRecycler;

    invoke-virtual {v2, v12}, Lcom/ning/compress/BufferRecycler;->releaseInputBuffer([B)V
