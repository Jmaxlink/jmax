...
.method public decode(Lio/netty/buffer/ByteBuf;)V
    ...
    .line 155
    :cond_15
    iget v0, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->maxChunkSize:I
    ...
    .line 136
    iget v2, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->spdyVersion:I
    ...
    iget-byte v7, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->flags:B

    iget v8, p0, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->length:I

    invoke-static {v2, v6, v7, v8}, Lio/netty/handler/codec/spdy/SpdyFrameDecoder;->isValidFrameHeader(IIBI)Z
