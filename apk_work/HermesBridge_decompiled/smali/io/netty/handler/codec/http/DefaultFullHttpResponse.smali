...
.method public constructor <init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpResponseStatus;Lio/netty/buffer/ByteBuf;)V
    ...
    .param p1, "version"    # Lio/netty/handler/codec/http/HttpVersion;
    .param p2, "status"    # Lio/netty/handler/codec/http/HttpResponseStatus;
    .param p3, "content"    # Lio/netty/buffer/ByteBuf;
...
.method public constructor <init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpResponseStatus;Lio/netty/buffer/ByteBuf;Lio/netty/handler/codec/http/HttpHeaders;Lio/netty/handler/codec/http/HttpHeaders;)V
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->content:Lio/netty/buffer/ByteBuf;
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->trailingHeaders:Lio/netty/handler/codec/http/HttpHeaders;
...
.method public constructor <init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpResponseStatus;Lio/netty/buffer/ByteBuf;ZZ)V
    ...
    invoke-direct {v0, p4}, Lio/netty/handler/codec/http/CombinedHttpHeaders;-><init>(Z)V
    ...
    invoke-direct {v0, p4}, Lio/netty/handler/codec/http/DefaultHttpHeaders;-><init>(Z)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v0, Lio/netty/handler/codec/http/DefaultFullHttpResponse;

    .line 188
    .local v0, "other":Lio/netty/handler/codec/http/DefaultFullHttpResponse;
    invoke-super {p0, v0}, Lio/netty/handler/codec/http/DefaultHttpResponse;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0}, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->content()Lio/netty/buffer/ByteBuf;
...
.method public hashCode()I
    ...
    invoke-static {v1}, Lio/netty/buffer/ByteBufUtil;->isAccessible(Lio/netty/buffer/ByteBuf;)Z
...
.method public replace(Lio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    invoke-virtual {p0}, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->protocolVersion()Lio/netty/handler/codec/http/HttpVersion;

    move-result-object v1

    invoke-virtual {p0}, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->status()Lio/netty/handler/codec/http/HttpResponseStatus;
    ...
    invoke-virtual {p0}, Lio/netty/handler/codec/http/DefaultFullHttpResponse;->decoderResult()Lio/netty/handler/codec/DecoderResult;

    move-result-object v1

    invoke-interface {v0, v1}, Lio/netty/handler/codec/http/FullHttpResponse;->setDecoderResult(Lio/netty/handler/codec/DecoderResult;)V
