...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;ZIZ)V
    ...
    .line 81
    invoke-direct {p0, p1, p2, v0}, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;-><init>(Ljava/lang/String;Ljava/lang/String;Lio/netty/handler/codec/http/websocketx/WebSocketDecoderConfig;)V
...
.method protected newHandshakeResponse(Lio/netty/handler/codec/http/FullHttpRequest;Lio/netty/handler/codec/http/HttpHeaders;)Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    sget-object v4, Lio/netty/handler/codec/http/HttpResponseStatus;->SWITCHING_PROTOCOLS:Lio/netty/handler/codec/http/HttpResponseStatus;
    ...
    invoke-virtual {v5}, Lio/netty/buffer/ByteBuf;->alloc()Lio/netty/buffer/ByteBufAllocator;
    ...
    .line 153
    .local v2, "res":Lio/netty/handler/codec/http/FullHttpResponse;
    if-eqz p2, :cond_0
    ...
    invoke-virtual {v3, p2}, Lio/netty/handler/codec/http/HttpHeaders;->add(Lio/netty/handler/codec/http/HttpHeaders;)Lio/netty/handler/codec/http/HttpHeaders;
    ...
    sget-object v6, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    const-string v7, "WebSocket version 08 server handshake key: {}, response: {}"

    invoke-interface {v6, v7, v1, v5}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 167
    invoke-virtual {v6, v7, v5}, Lio/netty/handler/codec/http/HttpHeaders;->set(Ljava/lang/CharSequence;Ljava/lang/Object;)Lio/netty/handler/codec/http/HttpHeaders;
    ...
    .line 171
    invoke-virtual {p0, v6}, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->selectSubprotocol(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 173
    sget-object v8, Lio/netty/handler/codec/http/websocketx/WebSocketServerHandshaker08;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    .line 147
    .end local v2    # "res":Lio/netty/handler/codec/http/FullHttpResponse;
    .end local v3    # "acceptSeed":Ljava/lang/String;
    .end local v4    # "sha1":[B
    ...
    const-string v3, "not a WebSocket request: missing key"
