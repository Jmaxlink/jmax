...
.method private createUpgradeResponse(Ljava/lang/CharSequence;)Lio/netty/handler/codec/http/FullHttpResponse;
    .locals 5
    .param p1, "upgradeProtocol"    # Ljava/lang/CharSequence;
...
.method private upgrade(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/FullHttpRequest;)Z
    ...
    .line 353
    :cond_7
    invoke-direct {p0, v3}, Lio/netty/handler/codec/http/HttpServerUpgradeHandler;->createUpgradeResponse(Ljava/lang/CharSequence;)Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    .line 327
    .end local v6    # "concatenatedConnectionValue":Ljava/lang/StringBuilder;
    .end local v7    # "requiredHeaders":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/lang/CharSequence;>;"
    .end local v9    # "values":Ljava/util/List;, "Ljava/util/List<Ljava/lang/CharSequence;>;"
    :cond_a
    :goto_5
    return v4
.end method
...
.method protected decode(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;Ljava/util/List;)V
    ...
    .line 236
    .restart local v0    # "req":Lio/netty/handler/codec/http/HttpRequest;
    :cond_0
