...
.method private encodeNextChunkMultipart(I)Lio/netty/handler/codec/http/HttpContent;
    ...
    instance-of v0, v0, Lio/netty/handler/codec/http/multipart/InternalAttribute;
...
.method private encodeNextChunkUrlEncoded(I)Lio/netty/handler/codec/http/HttpContent;
    ...
    .line 945
    iget-object v2, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->currentData:Lio/netty/handler/codec/http/multipart/InterfaceHttpData;
    ...
    iget-object v8, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->charset:Ljava/nio/charset/Charset;
    ...
    .line 947
    .local v8, "buffer":Lio/netty/buffer/ByteBuf;
    ...
    new-array v10, v5, [Lio/netty/buffer/ByteBuf;

    aput-object v8, v10, v6

    aput-object v9, v10, v7

    invoke-static {v10}, Lio/netty/buffer/Unpooled;->wrappedBuffer([Lio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;
    ...
    iget-object v11, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->charset:Ljava/nio/charset/Charset;
    ...
    new-array v11, v3, [Lio/netty/buffer/ByteBuf;
    ...
    .line 957
    .end local v8    # "buffer":Lio/netty/buffer/ByteBuf;
    ...
    invoke-interface {v2, v0}, Lio/netty/handler/codec/http/multipart/HttpData;->getChunk(I)Lio/netty/buffer/ByteBuf;
    ...
    .line 970
    .local v8, "delimiter":Lio/netty/buffer/ByteBuf;
    invoke-virtual {v2}, Lio/netty/buffer/ByteBuf;->readableBytes()I
    ...
    iget-object v10, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->charset:Ljava/nio/charset/Charset;
    ...
    .line 978
    iget-object v3, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->currentBuffer:Lio/netty/buffer/ByteBuf;
    ...
    .line 982
    :cond_5
    iput-object v8, p0, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->currentBuffer:Lio/netty/buffer/ByteBuf;
    ...
    .restart local v1    # "buffer":Lio/netty/buffer/ByteBuf;
    ...
    .line 993
    .end local v1    # "buffer":Lio/netty/buffer/ByteBuf;
    .restart local v2    # "buffer":Lio/netty/buffer/ByteBuf;
    :cond_8
    return-object v1
    ...
    .line 999
    new-array v3, v5, [Lio/netty/buffer/ByteBuf;
    ...
    .line 964
    .end local v1    # "buffer":Lio/netty/buffer/ByteBuf;
    .end local v8    # "delimiter":Lio/netty/buffer/ByteBuf;
    :catch_0
    move-exception v1
    ...
    invoke-direct {v2, v1}, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder$ErrorDataEncoderException;-><init>(Ljava/lang/Throwable;)V
...
.method public addBodyHttpData(Lio/netty/handler/codec/http/multipart/InterfaceHttpData;)V
    ...
    iget-object v6, v1, Lio/netty/handler/codec/http/multipart/HttpPostRequestEncoder;->multipartHttpDatas:Ljava/util/List;
...
.method public finalizeRequest()Lio/netty/handler/codec/http/HttpRequest;
    ...
    instance-of v7, v7, Lio/netty/handler/codec/http/FullHttpRequest;
