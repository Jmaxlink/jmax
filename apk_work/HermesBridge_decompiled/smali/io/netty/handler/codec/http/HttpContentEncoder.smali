...
.method protected encode(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpObject;Ljava/util/List;)V
    ...
    invoke-virtual {v3}, Lio/netty/handler/codec/http/HttpResponseStatus;->codeClass()Lio/netty/handler/codec/http/HttpStatusClass;

    move-result-object v3

    .line 117
    .local v3, "codeClass":Lio/netty/handler/codec/http/HttpStatusClass;
    ...
    .local v4, "acceptEncoding":Ljava/lang/CharSequence;
    goto :goto_1

    .line 124
    .end local v4    # "acceptEncoding":Ljava/lang/CharSequence;
    :cond_1
    iget-object v4, p0, Lio/netty/handler/codec/http/HttpContentEncoder;->acceptEncodingQueue:Ljava/util/Queue;
    ...
    .line 125
    .restart local v4    # "acceptEncoding":Ljava/lang/CharSequence;
    if-eqz v4, :cond_a
    ...
    invoke-static {v5, v2, v4}, Lio/netty/handler/codec/http/HttpContentEncoder;->isPassthru(Lio/netty/handler/codec/http/HttpVersion;ILjava/lang/CharSequence;)Z
    ...
    check-cast v5, Lio/netty/buffer/ByteBufHolder;

    invoke-interface {v5}, Lio/netty/buffer/ByteBufHolder;->content()Lio/netty/buffer/ByteBuf;
    ...
    invoke-virtual {p0, v1, v5}, Lio/netty/handler/codec/http/HttpContentEncoder;->beginEncode(Lio/netty/handler/codec/http/HttpResponse;Ljava/lang/String;)Lio/netty/handler/codec/http/HttpContentEncoder$Result;

    move-result-object v5

    .line 166
    .local v5, "result":Lio/netty/handler/codec/http/HttpContentEncoder$Result;
    if-nez v5, :cond_6
    ...
    .line 172
    sget-object v6, Lio/netty/handler/codec/http/HttpContentEncoder$State;->PASS_THROUGH:Lio/netty/handler/codec/http/HttpContentEncoder$State;

    iput-object v6, p0, Lio/netty/handler/codec/http/HttpContentEncoder;->state:Lio/netty/handler/codec/http/HttpContentEncoder$State;
    ...
    .line 177
    :cond_6
    invoke-virtual {v5}, Lio/netty/handler/codec/http/HttpContentEncoder$Result;->contentEncoder()Lio/netty/channel/embedded/EmbeddedChannel;

    move-result-object v6

    iput-object v6, p0, Lio/netty/handler/codec/http/HttpContentEncoder;->encoder:Lio/netty/channel/embedded/EmbeddedChannel;
    ...
    sget-object v7, Lio/netty/handler/codec/http/HttpHeaderNames;->CONTENT_ENCODING:Lio/netty/util/AsciiString;

    invoke-virtual {v5}, Lio/netty/handler/codec/http/HttpContentEncoder$Result;->targetContentEncoding()Ljava/lang/String;
    ...
    .line 186
    new-instance v6, Lio/netty/handler/codec/http/DefaultHttpResponse;
    ...
    invoke-direct {v6, v7, v8}, Lio/netty/handler/codec/http/DefaultHttpResponse;-><init>(Lio/netty/handler/codec/http/HttpVersion;Lio/netty/handler/codec/http/HttpResponseStatus;)V

    .line 187
    .local v6, "newRes":Lio/netty/handler/codec/http/HttpResponse;
    invoke-interface {v6}, Lio/netty/handler/codec/http/HttpResponse;->headers()Lio/netty/handler/codec/http/HttpHeaders;
    ...
    invoke-virtual {v7, v8}, Lio/netty/handler/codec/http/HttpHeaders;->set(Lio/netty/handler/codec/http/HttpHeaders;)Lio/netty/handler/codec/http/HttpHeaders;
    ...
    check-cast v7, Lio/netty/handler/codec/http/HttpContent;

    invoke-direct {p0, v6, v7, p3}, Lio/netty/handler/codec/http/HttpContentEncoder;->encodeFullResponse(Lio/netty/handler/codec/http/HttpResponse;Lio/netty/handler/codec/http/HttpContent;Ljava/util/List;)V

    .line 192
    goto :goto_2

    .line 195
    .end local v6    # "newRes":Lio/netty/handler/codec/http/HttpResponse;
    :cond_7
    invoke-interface {v1}, Lio/netty/handler/codec/http/HttpResponse;->headers()Lio/netty/handler/codec/http/HttpHeaders;
    ...
    .line 199
    sget-object v6, Lio/netty/handler/codec/http/HttpContentEncoder$State;->AWAIT_CONTENT:Lio/netty/handler/codec/http/HttpContentEncoder$State;

    iput-object v6, p0, Lio/netty/handler/codec/http/HttpContentEncoder;->state:Lio/netty/handler/codec/http/HttpContentEncoder$State;

    .line 200
    instance-of v6, p2, Lio/netty/handler/codec/http/HttpContent;
    ...
    .end local v2    # "code":I
    .end local v3    # "codeClass":Lio/netty/handler/codec/http/HttpStatusClass;
    .end local v4    # "acceptEncoding":Ljava/lang/CharSequence;
    .end local v5    # "result":Lio/netty/handler/codec/http/HttpContentEncoder$Result;
    :cond_8
    :pswitch_2
    invoke-static {p2}, Lio/netty/handler/codec/http/HttpContentEncoder;->ensureContent(Lio/netty/handler/codec/http/HttpObject;)V
    ...
    .restart local v3    # "codeClass":Lio/netty/handler/codec/http/HttpStatusClass;
    .restart local v4    # "acceptEncoding":Ljava/lang/CharSequence;
    :cond_a
    new-instance v5, Ljava/lang/IllegalStateException;

    const-string v6, "cannot send more responses than requests"
