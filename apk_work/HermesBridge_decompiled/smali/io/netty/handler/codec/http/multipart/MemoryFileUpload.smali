...
.method public compareTo(Lio/netty/handler/codec/http/multipart/InterfaceHttpData;)I
    ...
    invoke-virtual {p0, v0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->compareTo(Lio/netty/handler/codec/http/multipart/FileUpload;)I
...
.method public copy()Lio/netty/handler/codec/http/multipart/FileUpload;
    ...
    .line 120
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->content()Lio/netty/buffer/ByteBuf;
    ...
    :goto_0
    invoke-virtual {p0, v1}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->replace(Lio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/http/multipart/FileUpload;
...
.method public replace(Lio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/http/multipart/FileUpload;
    ...
    .line 153
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->getName()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->getCharset()Ljava/nio/charset/Charset;

    move-result-object v5

    iget-wide v6, p0, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->size:J
    ...
    .line 154
    .local v0, "upload":Lio/netty/handler/codec/http/multipart/MemoryFileUpload;
    if-eqz p1, :cond_0

    .line 156
    :try_start_0
    invoke-virtual {v0, p1}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->setContent(Lio/netty/buffer/ByteBuf;)V
    :try_end_0
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->isCompleted()Z

    move-result v1

    invoke-virtual {v0, v1}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->setCompleted(Z)V
...
.method public setContentType(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->contentType:Ljava/lang/String;
...
.method public setFilename(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->filename:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    .line 113
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->length()J
    ...
    .line 115
    invoke-virtual {p0}, Lio/netty/handler/codec/http/multipart/MemoryFileUpload;->isInMemory()Z
