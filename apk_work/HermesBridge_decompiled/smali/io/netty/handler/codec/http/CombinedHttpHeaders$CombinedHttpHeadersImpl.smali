...
# direct methods
.method constructor <init>(Lio/netty/util/HashingStrategy;Lio/netty/handler/codec/ValueConverter;Lio/netty/handler/codec/DefaultHeaders$NameValidator;Lio/netty/handler/codec/DefaultHeaders$ValueValidator;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .local p4, "valueValidator":Lio/netty/handler/codec/DefaultHeaders$ValueValidator;, "Lio/netty/handler/codec/DefaultHeaders$ValueValidator<Ljava/lang/CharSequence;>;"
    const/16 v4, 0x10
...
.method private addEscapedValue(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl;
    ...
    .line 231
    invoke-virtual {p0, p1}, Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v1}, Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl;->set(Ljava/lang/Object;Ljava/lang/Object;)Lio/netty/handler/codec/Headers;
...
.method private static commaSeparate(Ljava/lang/CharSequence;Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl$CsvValueEscaper;Ljava/lang/Iterable;)Ljava/lang/CharSequence;
    ...
    .line 255
    .local p1, "escaper":Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl$CsvValueEscaper;, "Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl$CsvValueEscaper<TT;>;"
    ...
    .line 261
    invoke-interface {p1, p0, v2}, Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl$CsvValueEscaper;->escape(Ljava/lang/CharSequence;Ljava/lang/Object;)Ljava/lang/CharSequence;
...
.method public set(Ljava/lang/CharSequence;Ljava/lang/Iterable;)Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl;
    ...
    invoke-virtual {p0, p1, v0}, Lio/netty/handler/codec/http/CombinedHttpHeaders$CombinedHttpHeadersImpl;->set(Ljava/lang/Object;Ljava/lang/Object;)Lio/netty/handler/codec/Headers;
