...
.method private decompressContent(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/websocketx/WebSocketFrame;)Lio/netty/buffer/ByteBuf;
    ...
    invoke-interface {v3}, Lio/netty/buffer/ByteBufAllocator;->compositeBuffer()Lio/netty/buffer/CompositeByteBuf;

    move-result-object v3

    .line 126
    .local v3, "compositeDecompressedContent":Lio/netty/buffer/CompositeByteBuf;
    :goto_1
    ...
    invoke-virtual {v3}, Lio/netty/buffer/CompositeByteBuf;->numComponents()I
    ...
    .line 142
    :cond_4
    invoke-virtual {v3}, Lio/netty/buffer/CompositeByteBuf;->release()Z
    ...
    invoke-direct {v1, v4}, Lio/netty/handler/codec/CodecException;-><init>(Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lio/netty/handler/codec/http/websocketx/extensions/compression/DeflateDecoder;->noContext:Z
    ...
    .line 134
    :cond_8
    invoke-virtual {v3, v1, v4}, Lio/netty/buffer/CompositeByteBuf;->addComponent(ZLio/netty/buffer/ByteBuf;)Lio/netty/buffer/CompositeByteBuf;
