...
.method constructor <init>(Ljava/net/URI;Lio/netty/handler/codec/http/websocketx/WebSocketVersion;Ljava/lang/String;ZLio/netty/handler/codec/http/HttpHeaders;IZZJZZ)V
    .locals 11
    .param p1, "webSocketURL"    # Ljava/net/URI;
    .param p2, "version"    # Lio/netty/handler/codec/http/websocketx/WebSocketVersion;
    .param p3, "subprotocol"    # Ljava/lang/String;
    ...
    .param p9, "forceCloseTimeoutMillis"    # J
    .param p11, "absoluteUpgradeUrl"    # Z
    .param p12, "generateOriginHeader"    # Z
    ...
    iput-boolean v1, v10, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->performMasking:Z

    .line 215
    move/from16 v2, p8

    iput-boolean v2, v10, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->allowMaskMismatch:Z
...
.method protected newHandshakeRequest()Lio/netty/handler/codec/http/FullHttpRequest;
    ...
    iput-object v5, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->expectedChallengeResponseString:Ljava/lang/String;

    .line 248
    sget-object v5, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    const-string v6, "WebSocket version 07 client handshake key: {}, expected response: {}"

    iget-object v7, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->expectedChallengeResponseString:Ljava/lang/String;
    ...
    iget-object v7, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->customHeaders:Lio/netty/handler/codec/http/HttpHeaders;
    ...
    .line 275
    iget-boolean v7, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->generateOriginHeader:Z
...
.method protected verify(Lio/netty/handler/codec/http/FullHttpResponse;)V
    ...
    iget-object v5, p0, Lio/netty/handler/codec/http/websocketx/WebSocketClientHandshaker07;->expectedChallengeResponseString:Ljava/lang/String;

    filled-new-array {v3, v5}, [Ljava/lang/Object;

    move-result-object v5

    const-string v6, "Invalid challenge. Actual: %s. Expected: %s"
