...
.method decode(Lio/netty/buffer/ByteBuf;IILio/netty/buffer/ByteBufAllocator;Lio/netty/handler/codec/base64/Base64Dialect;)Lio/netty/buffer/ByteBuf;
    ...
    iget v1, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->outBuffPosn:I
...
.method public process(B)Z
    ...
    iget v3, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->b4Posn:I
    ...
    .line 338
    iget v1, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->b4Posn:I
    ...
    iget-object v3, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->b4:[B

    iget-object v4, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->dest:Lio/netty/buffer/ByteBuf;

    iget v5, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->outBuffPosn:I

    iget-object v6, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->decodabet:[B

    invoke-static {v3, v4, v5, v6}, Lio/netty/handler/codec/base64/Base64$Decoder;->decode4to3([BLio/netty/buffer/ByteBuf;I[B)I

    move-result v3

    add-int/2addr v1, v3

    iput v1, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->outBuffPosn:I

    .line 340
    const/4 v1, 0x0

    iput v1, p0, Lio/netty/handler/codec/base64/Base64$Decoder;->b4Posn:I
