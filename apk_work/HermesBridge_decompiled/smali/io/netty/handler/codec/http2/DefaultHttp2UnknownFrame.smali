...
.method public constructor <init>(BLio/netty/handler/codec/http2/Http2Flags;)V
    ...
    .param p2, "flags"    # Lio/netty/handler/codec/http2/Http2Flags;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v0, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;

    .line 122
    .local v0, "other":Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->stream()Lio/netty/handler/codec/http2/Http2FrameStream;

    move-result-object v2

    .line 123
    .local v2, "otherStream":Lio/netty/handler/codec/http2/Http2FrameStream;
    iget-object v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->stream:Lio/netty/handler/codec/http2/Http2FrameStream;
    ...
    :cond_1
    iget-object v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->flags:Lio/netty/handler/codec/http2/Http2Flags;

    .line 124
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->flags()Lio/netty/handler/codec/http2/Http2Flags;

    move-result-object v4

    invoke-virtual {v3, v4}, Lio/netty/handler/codec/http2/Http2Flags;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_2

    iget-byte v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->frameType:B

    .line 125
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->frameType()B
    ...
    .line 126
    invoke-super {p0, v0}, Lio/netty/buffer/DefaultByteBufHolder;->equals(Ljava/lang/Object;)Z
...
.method public hashCode()I
    ...
    iget-byte v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->frameType:B
    ...
    invoke-virtual {v2}, Lio/netty/handler/codec/http2/Http2Flags;->hashCode()I
...
.method public replace(Lio/netty/buffer/ByteBuf;)Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;
    ...
    invoke-virtual {v0, v1}, Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;->stream(Lio/netty/handler/codec/http2/Http2FrameStream;)Lio/netty/handler/codec/http2/DefaultHttp2UnknownFrame;
