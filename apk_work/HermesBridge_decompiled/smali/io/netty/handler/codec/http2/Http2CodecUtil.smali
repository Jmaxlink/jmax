...
.method public static headerListSizeExceeded(IJZ)V
    ...
    .line 233
    const-string v2, "Header size exceeded max allowed size (%d)"

    invoke-static {p0, v0, p3, v2, v1}, Lio/netty/handler/codec/http2/Http2Exception;->headerListSizeError(ILio/netty/handler/codec/http2/Http2Error;ZLjava/lang/String;[Ljava/lang/Object;)Lio/netty/handler/codec/http2/Http2Exception;
...
.method static isStreamIdValid(IZ)Z
    .locals 3
    .param p0, "streamId"    # I
    .param p1, "server"    # Z
...
.method public static streamableBytes(Lio/netty/handler/codec/http2/StreamByteDistributor$StreamState;)I
    .locals 4
    .param p0, "state"    # Lio/netty/handler/codec/http2/StreamByteDistributor$StreamState;
...
.method public static toByteBuf(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Throwable;)Lio/netty/buffer/ByteBuf;
    ...
    invoke-static {v0, v1}, Lio/netty/buffer/ByteBufUtil;->writeUtf8(Lio/netty/buffer/ByteBufAllocator;Ljava/lang/CharSequence;)Lio/netty/buffer/ByteBuf;
...
.method public static verifyPadding(I)V
    ...
    .line 399
    const-string v2, "Invalid padding \'%d\'. Padding must be between 0 and %d (inclusive)."
...
.method public static writeFrameHeader(Lio/netty/buffer/ByteBuf;IBLio/netty/handler/codec/http2/Http2Flags;I)V
    ...
    .param p2, "type"    # B
    .param p3, "flags"    # Lio/netty/handler/codec/http2/Http2Flags;
    .param p4, "streamId"    # I
