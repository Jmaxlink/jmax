...
.method public constructor <init>(Lio/netty/handler/codec/http2/Http2ConnectionHandler;Lio/netty/handler/codec/http2/Http2MultiplexHandler;)V
    .locals 2
    .param p1, "connectionHandler"    # Lio/netty/handler/codec/http2/Http2ConnectionHandler;
    .param p2, "http2MultiplexHandler"    # Lio/netty/handler/codec/http2/Http2MultiplexHandler;
...
.method public constructor <init>(Lio/netty/handler/codec/http2/Http2FrameCodec;Lio/netty/channel/ChannelHandler;)V
    .locals 1
    .param p1, "frameCodec"    # Lio/netty/handler/codec/http2/Http2FrameCodec;
    .param p2, "upgradeToHandler"    # Lio/netty/channel/ChannelHandler;
...
.method private constructor <init>(Ljava/lang/String;Lio/netty/handler/codec/http2/Http2ConnectionHandler;Lio/netty/channel/ChannelHandler;Lio/netty/handler/codec/http2/Http2MultiplexHandler;)V
    ...
    .param p1, "handlerName"    # Ljava/lang/String;
    .param p2, "connectionHandler"    # Lio/netty/handler/codec/http2/Http2ConnectionHandler;
    .param p3, "upgradeToHandler"    # Lio/netty/channel/ChannelHandler;
    .param p4, "http2MultiplexHandler"    # Lio/netty/handler/codec/http2/Http2MultiplexHandler;
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->connectionHandler:Lio/netty/handler/codec/http2/Http2ConnectionHandler;

    .line 109
    const-string v0, "upgradeToHandler"
    ...
    iput-object v0, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->upgradeToHandler:Lio/netty/channel/ChannelHandler;
...
.method public constructor <init>(Ljava/lang/String;Lio/netty/handler/codec/http2/Http2ConnectionHandler;Lio/netty/handler/codec/http2/Http2MultiplexHandler;)V
    ...
    .param p1, "handlerName"    # Ljava/lang/String;
    .param p2, "connectionHandler"    # Lio/netty/handler/codec/http2/Http2ConnectionHandler;
    .param p3, "http2MultiplexHandler"    # Lio/netty/handler/codec/http2/Http2MultiplexHandler;
...
.method public constructor <init>(Ljava/lang/String;Lio/netty/handler/codec/http2/Http2FrameCodec;Lio/netty/channel/ChannelHandler;)V
    .locals 1
    .param p1, "handlerName"    # Ljava/lang/String;
    .param p2, "frameCodec"    # Lio/netty/handler/codec/http2/Http2FrameCodec;
    .param p3, "upgradeToHandler"    # Lio/netty/channel/ChannelHandler;
...
.method private getSettingsHeaderValue(Lio/netty/channel/ChannelHandlerContext;)Ljava/lang/CharSequence;
    ...
    .line 157
    .local v1, "encodedBuf":Lio/netty/buffer/ByteBuf;
    :try_start_0
    iget-object v2, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->connectionHandler:Lio/netty/handler/codec/http2/Http2ConnectionHandler;
    ...
    invoke-interface {v2}, Lio/netty/handler/codec/http2/Http2ConnectionDecoder;->localSettings()Lio/netty/handler/codec/http2/Http2Settings;

    move-result-object v2

    .line 160
    .local v2, "settings":Lio/netty/handler/codec/http2/Http2Settings;
    invoke-virtual {v2}, Lio/netty/handler/codec/http2/Http2Settings;->size()I
    ...
    .line 162
    invoke-virtual {v2}, Lio/netty/handler/codec/http2/Http2Settings;->entries()Ljava/lang/Iterable;
    ...
    check-cast v5, Lio/netty/util/collection/CharObjectMap$PrimitiveEntry;

    .line 163
    .local v5, "entry":Lio/netty/util/collection/CharObjectMap$PrimitiveEntry;, "Lio/netty/util/collection/CharObjectMap$PrimitiveEntry<Ljava/lang/Long;>;"
    invoke-interface {v5}, Lio/netty/util/collection/CharObjectMap$PrimitiveEntry;->key()C

    move-result v6

    invoke-virtual {v0, v6}, Lio/netty/buffer/ByteBuf;->writeChar(I)Lio/netty/buffer/ByteBuf;

    .line 164
    invoke-interface {v5}, Lio/netty/util/collection/CharObjectMap$PrimitiveEntry;->value()Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6}, Lio/netty/buffer/ByteBuf;->writeInt(I)Lio/netty/buffer/ByteBuf;

    .line 165
    nop

    .end local v5    # "entry":Lio/netty/util/collection/CharObjectMap$PrimitiveEntry;, "Lio/netty/util/collection/CharObjectMap$PrimitiveEntry<Ljava/lang/Long;>;"
    goto :goto_0

    .line 168
    :cond_0
    sget-object v4, Lio/netty/handler/codec/base64/Base64Dialect;->URL_SAFE:Lio/netty/handler/codec/base64/Base64Dialect;

    invoke-static {v0, v4}, Lio/netty/handler/codec/base64/Base64;->encode(Lio/netty/buffer/ByteBuf;Lio/netty/handler/codec/base64/Base64Dialect;)Lio/netty/buffer/ByteBuf;
    ...
    invoke-virtual {v1, v4}, Lio/netty/buffer/ByteBuf;->toString(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 171
    .end local v2    # "settings":Lio/netty/handler/codec/http2/Http2Settings;
...
.method public setUpgradeHeaders(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpRequest;)Ljava/util/Collection;
    .locals 3
    .param p1, "ctx"    # Lio/netty/channel/ChannelHandlerContext;
    .param p2, "upgradeRequest"    # Lio/netty/handler/codec/http/HttpRequest;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 122
    .local v0, "settingsValue":Ljava/lang/CharSequence;
    ...
    .line 123
    sget-object v1, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->UPGRADE_HEADERS:Ljava/util/List;
...
.method public upgradeTo(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/FullHttpResponse;)V
    .locals 4
    .param p1, "ctx"    # Lio/netty/channel/ChannelHandlerContext;
    .param p2, "upgradeResponse"    # Lio/netty/handler/codec/http/FullHttpResponse;
    ...
    iget-object v2, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->handlerName:Ljava/lang/String;

    iget-object v3, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->upgradeToHandler:Lio/netty/channel/ChannelHandler;
    ...
    .line 135
    iget-object v0, p0, Lio/netty/handler/codec/http2/Http2ClientUpgradeCodec;->http2MultiplexHandler:Lio/netty/channel/ChannelHandler;
    ...
    invoke-interface {v1, v0, v3, v2}, Lio/netty/channel/ChannelPipeline;->addAfter(Ljava/lang/String;Ljava/lang/String;Lio/netty/channel/ChannelHandler;)Lio/netty/channel/ChannelPipeline;
    ...
    invoke-virtual {v0}, Lio/netty/handler/codec/http2/Http2ConnectionHandler;->onHttpClientUpgrade()V
    :try_end_0
