...
.method static synthetic access$1300(Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;)Lio/netty/handler/codec/http2/Http2Stream;
    .locals 1
    .param p0, "x0"    # Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;
...
.method private decrementFlowControlWindow(I)V
    ...
    .line 520
    invoke-virtual {p0, v0}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->incrementStreamWindow(I)I
    :try_end_0
    ...
    const-string v3, "Invalid window state when writing frame: "
...
.method private decrementPendingBytes(IZ)V
    .locals 1
    .param p1, "bytes"    # I
    .param p2, "updateStreamableBytes"    # Z

    .line 510
    neg-int v0, p1

    invoke-direct {p0, v0, p2}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->incrementPendingBytes(IZ)V
...
.method private enqueueFrameWithoutMerge(Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;)V
    .locals 2
    .param p1, "frame"    # Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;
    ...
    invoke-direct {p0, v0, v1}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->incrementPendingBytes(IZ)V
...
.method private incrementPendingBytes(IZ)V
    ...
    invoke-static {v0}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;->access$600(Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;)Lio/netty/handler/codec/http2/StreamByteDistributor;

    move-result-object v0

    invoke-interface {v0, p0}, Lio/netty/handler/codec/http2/StreamByteDistributor;->updateStreamableBytes(Lio/netty/handler/codec/http2/StreamByteDistributor$StreamState;)V
...
.method cancel(Lio/netty/handler/codec/http2/Http2Error;Ljava/lang/Throwable;)V
    ...
    .line 479
    .local v0, "frame":Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;
    if-eqz v0, :cond_2
    ...
    .line 484
    .local v1, "exception":Lio/netty/handler/codec/http2/Http2Exception;
    :cond_1
    ...
    .line 485
    iget-object v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->pendingWriteQueue:Ljava/util/Deque;
    ...
    .line 489
    .end local v1    # "exception":Lio/netty/handler/codec/http2/Http2Exception;
    :cond_2
    iget-object v1, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->this$0:Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;
    ...
    invoke-interface {v1, p0}, Lio/netty/handler/codec/http2/StreamByteDistributor;->updateStreamableBytes(Lio/netty/handler/codec/http2/StreamByteDistributor$StreamState;)V

    .line 491
    iget-object v1, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->this$0:Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;

    invoke-static {v1}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;->access$300(Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;)Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$WritabilityMonitor;

    move-result-object v1

    invoke-virtual {v1, p0}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$WritabilityMonitor;->stateCancelled(Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;)V
...
.method enqueueFrame(Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;)V
    ...
    .line 434
    .local v0, "last":Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;
    if-nez v0, :cond_0
    ...
    invoke-direct {p0, v2, v3}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->incrementPendingBytes(IZ)V
...
.method incrementStreamWindow(I)I
    ...
    iget-object v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->stream:Lio/netty/handler/codec/http2/Http2Stream;
    ...
    .line 408
    const-string v3, "Window size overflow for stream: %d"
...
.method writeAllocatedBytes(I)I
    .locals 10
    .param p1, "allocated"    # I

    .line 341
    move v0, p1

    .line 344
    .local v0, "initialAllocated":I
    const/4 v1, 0x0
    ...
    :try_start_0
    iget-boolean v4, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->writing:Z

    if-nez v4, :cond_5

    .line 348
    iput-boolean v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->writing:Z

    .line 351
    const/4 v4, 0x0

    .line 352
    .local v4, "writeOccurred":Z
    :goto_0
    ...
    .local v6, "frame":Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;
    if-eqz v5, :cond_2
    ...
    invoke-interface {v6}, Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;->size()I
    ...
    .line 362
    .local v7, "initialFrameSize":I
    :try_start_1
    iget-object v8, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->this$0:Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;

    invoke-static {v8}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;->access$500(Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController;)Lio/netty/channel/ChannelHandlerContext;
    ...
    invoke-interface {v6, v8, v9}, Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;->write(Lio/netty/channel/ChannelHandlerContext;I)V
    ...
    .line 367
    iget-object v8, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->pendingWriteQueue:Ljava/util/Deque;

    invoke-interface {v8}, Ljava/util/Deque;->remove()Ljava/lang/Object;

    .line 368
    invoke-interface {v6}, Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;->writeComplete()V
    :try_end_1
    ...
    .line 374
    .end local v5    # "maxBytes":I
    .end local v7    # "initialFrameSize":I
    goto :goto_0

    .line 372
    .restart local v5    # "maxBytes":I
    .restart local v7    # "initialFrameSize":I
    :catchall_0
    move-exception v8
    ...
    .end local v0    # "initialAllocated":I
    .end local v1    # "cause":Ljava/lang/Throwable;
    .end local p1    # "allocated":I
    throw v8
    :try_end_2
    ...
    .line 376
    .end local v5    # "maxBytes":I
    .end local v6    # "frame":Lio/netty/handler/codec/http2/Http2RemoteFlowController$FlowControlled;
    .end local v7    # "initialFrameSize":I
    .restart local v0    # "initialAllocated":I
    .restart local v1    # "cause":Ljava/lang/Throwable;
    .restart local p1    # "allocated":I
    :cond_2
    :goto_1
    if-nez v4, :cond_4
    ...
    .line 386
    iput-boolean v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->writing:Z
    ...
    invoke-direct {p0, v2, v3}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->decrementPendingBytes(IZ)V

    .line 392
    invoke-direct {p0, v2}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->decrementFlowControlWindow(I)V

    .line 396
    iget-boolean v3, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->cancelled:Z
    ...
    invoke-virtual {p0, v3, v1}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->cancel(Lio/netty/handler/codec/http2/Http2Error;Ljava/lang/Throwable;)V
    ...
    :goto_3
    :try_start_4
    iput-boolean v2, p0, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->cancelled:Z
    :try_end_4
    ...
    invoke-direct {p0, v4, v3}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->decrementPendingBytes(IZ)V

    .line 392
    invoke-direct {p0, v4}, Lio/netty/handler/codec/http2/DefaultHttp2RemoteFlowController$FlowState;->decrementFlowControlWindow(I)V
