...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    invoke-interface {v4, v9}, Lio/netty/util/Attribute;->set(Ljava/lang/Object;)V
    ...
    .line 493
    .local v9, "reopenTask":Ljava/lang/Runnable;
    if-nez v9, :cond_1

    .line 494
    new-instance v10, Lio/netty/handler/traffic/AbstractTrafficShapingHandler$ReopenReadTimerTask;

    invoke-direct {v10, v7}, Lio/netty/handler/traffic/AbstractTrafficShapingHandler$ReopenReadTimerTask;-><init>(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-interface {v10, v9, v0, v1, v13}, Lio/netty/util/concurrent/EventExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;

    .line 498
    sget-object v10, Lio/netty/handler/traffic/AbstractTrafficShapingHandler;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    .line 499
    invoke-interface {v10, v5}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;)V
    ...
    .end local v9    # "reopenTask":Ljava/lang/Runnable;
    .end local v11    # "now":J
    .local v4, "now":J
    :cond_2
    move-wide v11, v4
