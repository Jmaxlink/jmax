...
.method public channelRead(Lio/netty/channel/ChannelHandlerContext;Ljava/lang/Object;)V
    ...
    invoke-interface {v3, v4}, Lio/netty/channel/ChannelConfig;->setAutoRead(Z)Lio/netty/channel/ChannelConfig;

    .line 555
    sget-object v4, Lio/netty/handler/traffic/GlobalChannelTrafficShapingHandler;->READ_SUSPENDED:Lio/netty/util/AttributeKey;

    invoke-interface {v2, v4}, Lio/netty/channel/Channel;->attr(Lio/netty/util/AttributeKey;)Lio/netty/util/Attribute;
    ...
    invoke-interface {v4, v13}, Lio/netty/util/Attribute;->set(Ljava/lang/Object;)V

    .line 558
    sget-object v4, Lio/netty/handler/traffic/GlobalChannelTrafficShapingHandler;->REOPEN_TASK:Lio/netty/util/AttributeKey;
    ...
    .line 559
    .local v4, "attr":Lio/netty/util/Attribute;, "Lio/netty/util/Attribute<Ljava/lang/Runnable;>;"
    ...
    .line 560
    .local v13, "reopenTask":Ljava/lang/Runnable;
    if-nez v13, :cond_6

    .line 561
    new-instance v14, Lio/netty/handler/traffic/AbstractTrafficShapingHandler$ReopenReadTimerTask;

    invoke-direct {v14, v7}, Lio/netty/handler/traffic/AbstractTrafficShapingHandler$ReopenReadTimerTask;-><init>(Lio/netty/channel/ChannelHandlerContext;)V
    ...
    invoke-interface {v14, v13, v0, v1, v15}, Lio/netty/util/concurrent/EventExecutor;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/netty/util/concurrent/ScheduledFuture;

    .line 565
    sget-object v14, Lio/netty/handler/traffic/GlobalChannelTrafficShapingHandler;->logger:Lio/netty/util/internal/logging/InternalLogger;
    ...
    .line 566
    invoke-interface {v14, v5}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;)V
    ...
    .end local v11    # "now":J
    .end local v13    # "reopenTask":Ljava/lang/Runnable;
...
.method createGlobalTrafficCounter(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iget-wide v5, p0, Lio/netty/handler/traffic/GlobalChannelTrafficShapingHandler;->checkInterval:J
