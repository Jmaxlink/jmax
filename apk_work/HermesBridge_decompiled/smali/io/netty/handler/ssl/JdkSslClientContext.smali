...
.method private static newSSLContext(Ljava/security/Provider;[Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;[Ljava/security/cert/X509Certificate;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;JJLjava/lang/String;)Ljavax/net/ssl/SSLContext;
    ...
    :try_start_0
    invoke-static {v2, v7, v13}, Lio/netty/handler/ssl/JdkSslClientContext;->buildTrustManagerFactory([Ljava/security/cert/X509Certificate;Ljavax/net/ssl/TrustManagerFactory;Ljava/lang/String;)Ljavax/net/ssl/TrustManagerFactory;
    ...
    :try_start_1
    invoke-static/range {v7 .. v12}, Lio/netty/handler/ssl/JdkSslClientContext;->buildKeyManagerFactory([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/PrivateKey;Ljava/lang/String;Ljavax/net/ssl/KeyManagerFactory;Ljava/lang/String;)Ljavax/net/ssl/KeyManagerFactory;
    ...
    .line 292
    .end local p6    # "keyManagerFactory":Ljavax/net/ssl/KeyManagerFactory;
    .local v7, "keyManagerFactory":Ljavax/net/ssl/KeyManagerFactory;
    :goto_1
    const-string v0, "TLS"
    ...
    .line 294
    invoke-virtual {v0, v9, v10, v8}, Ljavax/net/ssl/SSLContext;->init([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    ...
    .line 299
    .local v8, "sessCtx":Ljavax/net/ssl/SSLSessionContext;
    ...
    invoke-interface {v8, v11}, Ljavax/net/ssl/SSLSessionContext;->setSessionCacheSize(I)V
    ...
    invoke-interface {v8, v9}, Ljavax/net/ssl/SSLSessionContext;->setSessionTimeout(I)V
    :try_end_2
    ...
    .end local v8    # "sessCtx":Ljavax/net/ssl/SSLSessionContext;
    :catch_2
    move-exception v0
    ...
    :goto_5
    instance-of v8, v0, Ljavax/net/ssl/SSLException;
    ...
    check-cast v8, Ljavax/net/ssl/SSLException;
    ...
    const-string v9, "failed to initialize the client-side SSL context"
