...
.method private static cacheFromJava(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v1}, Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;->of(Ljava/lang/String;)Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;
...
.method private static cacheFromOpenSsl(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 349
    .local v5, "cachedValue":Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;
    sget-object v6, Lio/netty/handler/ssl/CipherSuiteConverter;->j2o:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-interface {v6, v2, v5}, Ljava/util/concurrent/ConcurrentMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 352
    sget-object v6, Lio/netty/handler/ssl/CipherSuiteConverter;->logger:Lio/netty/util/internal/logging/InternalLogger;

    const-string v7, "Cipher suite mapping: {} => {}"

    invoke-interface {v6, v7, v3, p0}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    .line 353
    sget-object v6, Lio/netty/handler/ssl/CipherSuiteConverter;->logger:Lio/netty/util/internal/logging/InternalLogger;

    invoke-interface {v6, v7, v2, p0}, Lio/netty/util/internal/logging/InternalLogger;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method static isJ2OCached(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 153
    .local v0, "cached":Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;
    if-eqz v0, :cond_0

    iget-object v1, v0, Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;->value:Ljava/lang/String;
...
.method public static toOpenSsl(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 175
    .local v0, "converted":Lio/netty/handler/ssl/CipherSuiteConverter$CachedValue;
    if-eqz v0, :cond_0
