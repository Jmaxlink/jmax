...
.method static toPEM(Lio/netty/buffer/ByteBufAllocator;Z[B)Lio/netty/handler/ssl/PemEncoded;
    ...
    .line 81
    .local v4, "pem":Lio/netty/buffer/ByteBuf;
    :goto_0
    :try_start_2
    sget-object v5, Lio/netty/handler/ssl/PemPrivateKey;->BEGIN_PRIVATE_KEY:[B

    invoke-virtual {v4, v5}, Lio/netty/buffer/ByteBuf;->writeBytes([B)Lio/netty/buffer/ByteBuf;

    .line 82
    invoke-virtual {v4, v1}, Lio/netty/buffer/ByteBuf;->writeBytes(Lio/netty/buffer/ByteBuf;)Lio/netty/buffer/ByteBuf;

    .line 83
    sget-object v5, Lio/netty/handler/ssl/PemPrivateKey;->END_PRIVATE_KEY:[B

    invoke-virtual {v4, v5}, Lio/netty/buffer/ByteBuf;->writeBytes([B)Lio/netty/buffer/ByteBuf;

    .line 85
    new-instance v5, Lio/netty/handler/ssl/PemValue;

    const/4 v6, 0x1

    invoke-direct {v5, v4, v6}, Lio/netty/handler/ssl/PemValue;-><init>(Lio/netty/buffer/ByteBuf;Z)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    .line 86
    .local v5, "value":Lio/netty/handler/ssl/PemValue;
    const/4 v3, 0x1
    ...
    .line 91
    :try_start_3
    invoke-static {v4}, Lio/netty/handler/ssl/SslUtils;->zerooutAndRelease(Lio/netty/buffer/ByteBuf;)V
    :try_end_3
    ...
    .line 90
    .end local v5    # "value":Lio/netty/handler/ssl/PemValue;
    :catchall_0
    move-exception v5
    ...
    .end local v4    # "pem":Lio/netty/buffer/ByteBuf;
