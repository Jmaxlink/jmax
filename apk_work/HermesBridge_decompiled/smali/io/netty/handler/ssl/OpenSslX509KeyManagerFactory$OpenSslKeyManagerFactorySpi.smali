...
.method constructor <init>(Ljavax/net/ssl/KeyManagerFactory;)V
    .locals 1
    .param p1, "kmf"    # Ljavax/net/ssl/KeyManagerFactory;
    ...
    iput-object v0, p0, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi;->kmf:Ljavax/net/ssl/KeyManagerFactory;
...
.method protected engineGetKeyManagers()[Ljavax/net/ssl/KeyManager;
    ...
    .line 149
    .local v0, "providerFactory":Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi$ProviderFactory;
    if-eqz v0, :cond_0
    ...
    const-string v2, "engineInit(...) not called yet"
...
.method protected declared-synchronized engineInit(Ljava/security/KeyStore;[C)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi$ProviderFactory;-><init>(Ljavax/net/ssl/X509KeyManager;Ljava/lang/String;Ljava/lang/Iterable;)V
    ...
    .line 125
    .end local p0    # "this":Lio/netty/handler/ssl/OpenSslX509KeyManagerFactory$OpenSslKeyManagerFactorySpi;
    :cond_0
    :try_start_1
    new-instance v0, Ljava/security/KeyStoreException;

    const-string v1, "No aliases found"
    ...
    .line 120
    .end local p1    # "keyStore":Ljava/security/KeyStore;
    .end local p2    # "chars":[C
    :catchall_0
    move-exception p1
