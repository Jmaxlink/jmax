...
# direct methods
.method constructor <init>(Lio/netty/handler/ssl/SslHandler;Lio/netty/util/concurrent/Future;Lio/netty/channel/ChannelHandlerContext;Lio/netty/channel/ChannelPromise;)V
    .locals 0
...
.method public operationComplete(Lio/netty/channel/ChannelFuture;)V
    ...
    .line 2296
    iget-object v0, p0, Lio/netty/handler/ssl/SslHandler$10;->val$timeoutFuture:Lio/netty/util/concurrent/Future;
    ...
    .line 2303
    iget-object v2, p0, Lio/netty/handler/ssl/SslHandler$10;->val$ctx:Lio/netty/channel/ChannelHandlerContext;

    iget-object v3, p0, Lio/netty/handler/ssl/SslHandler$10;->val$ctx:Lio/netty/channel/ChannelHandlerContext;
    ...
    iget-object v3, p0, Lio/netty/handler/ssl/SslHandler$10;->val$promise:Lio/netty/channel/ChannelPromise;
    ...
    .line 2307
    :cond_1
    iget-object v2, p0, Lio/netty/handler/ssl/SslHandler$10;->this$0:Lio/netty/handler/ssl/SslHandler;
    ...
    new-instance v3, Lio/netty/handler/ssl/SslHandler$10$1;

    invoke-direct {v3, p0, v0, v1}, Lio/netty/handler/ssl/SslHandler$10$1;-><init>(Lio/netty/handler/ssl/SslHandler$10;J)V
    ...
    .local v2, "closeNotifyReadTimeoutFuture":Lio/netty/util/concurrent/Future;, "Lio/netty/util/concurrent/Future<*>;"
    goto :goto_0

    .line 2322
    .end local v2    # "closeNotifyReadTimeoutFuture":Lio/netty/util/concurrent/Future;, "Lio/netty/util/concurrent/Future<*>;"
    :cond_2
    const/4 v2, 0x0

    .line 2326
    .restart local v2    # "closeNotifyReadTimeoutFuture":Lio/netty/util/concurrent/Future;, "Lio/netty/util/concurrent/Future<*>;"
    :goto_0
    iget-object v3, p0, Lio/netty/handler/ssl/SslHandler$10;->this$0:Lio/netty/handler/ssl/SslHandler;
    ...
    new-instance v4, Lio/netty/handler/ssl/SslHandler$10$2;

    invoke-direct {v4, p0, v2}, Lio/netty/handler/ssl/SslHandler$10$2;-><init>(Lio/netty/handler/ssl/SslHandler$10;Lio/netty/util/concurrent/Future;)V
