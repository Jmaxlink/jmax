...
.method public static final approximateCapturedTypes(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    .line 114
    .local v0, "boundsForFlexibleLower":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    .line 116
    .local v1, "boundsForFlexibleUpper":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    .line 124
    invoke-static {v4, p0}, Lkotlin/reflect/jvm/internal/impl/types/TypeWithEnhancementKt;->inheritEnhancement(Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/UnwrappedType;

    move-result-object v4

    .line 116
    invoke-direct {v2, v3, v4}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object v2

    .line 128
    .end local v0    # "boundsForFlexibleLower":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    .end local v1    # "boundsForFlexibleUpper":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    :cond_0
    ...
    .line 132
    .local v1, "typeProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    sget-object v5, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/CapturedTypeApproximationKt$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    const-string v5, "Only nontrivial projections should have been captured, not: "
    ...
    invoke-direct {v4, v2, v3}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string v5, "type.builtIns.nullableAnyType"

    invoke-static {v2, v5}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {v4, v3, v2}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 140
    .end local v1    # "typeProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    .line 144
    .local v1, "lowerBoundArguments":Ljava/util/ArrayList;
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 145
    .local v3, "upperBoundArguments":Ljava/util/ArrayList;
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/KotlinType;->getArguments()Ljava/util/List;
    ...
    .local v6, "typeProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    .line 149
    .local v7, "typeArgument":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    ...
    .line 153
    :cond_3
    invoke-static {v7}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/CapturedTypeApproximationKt;->approximateProjection(Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;)Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;

    move-result-object v8

    invoke-virtual {v8}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;->component1()Ljava/lang/Object;

    move-result-object v9

    check-cast v9, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;

    .local v9, "lower":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    invoke-virtual {v8}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;->component2()Ljava/lang/Object;
    ...
    .line 154
    .local v8, "upper":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    ...
    .end local v6    # "typeProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    .end local v7    # "typeArgument":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    .end local v8    # "upper":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    .end local v9    # "lower":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    :cond_4
    move-object v4, v1
    ...
    .local v9, "it":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    const/4 v10, 0x0

    .line 158
    .local v10, "$i$a$-any-CapturedTypeApproximationKt$approximateCapturedTypes$lowerBoundIsTrivial$1":I
    invoke-virtual {v9}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;->isConsistent()Z

    move-result v11

    .line 180
    .end local v9    # "it":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    .end local v10    # "$i$a$-any-CapturedTypeApproximationKt$approximateCapturedTypes$lowerBoundIsTrivial$1":I
    const/4 v9, 0x1
    ...
    .line 159
    .local v4, "lowerBoundIsTrivial":Z
    new-instance v5, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    invoke-virtual {v6}, Lkotlin/reflect/jvm/internal/impl/builtins/KotlinBuiltIns;->getNothingType()Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    ...
    .line 159
    invoke-direct {v5, v6, v2}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    return-object v5

    .line 141
    .end local v1    # "lowerBoundArguments":Ljava/util/ArrayList;
    .end local v3    # "upperBoundArguments":Ljava/util/ArrayList;
    .end local v4    # "lowerBoundIsTrivial":Z
    :cond_9
    :goto_4
    new-instance v1, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;

    invoke-direct {v1, p0, p0}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static final approximateCapturedTypes$makeNullableIfNeeded(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .locals 2
    .param p0, "$this$approximateCapturedTypes_u24makeNullableIfNeeded"    # Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    invoke-static {p0, v0}, Lkotlin/reflect/jvm/internal/impl/types/TypeUtils;->makeNullableIfNeeded(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Z)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;

    move-result-object v0

    const-string v1, "makeNullableIfNeeded(this, type.isMarkedNullable)"
...
.method public static final approximateCapturedTypesIfNecessary(Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;Z)Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    .line 85
    .local v2, "approximation":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    invoke-direct {v3, v1, v4}, Lkotlin/reflect/jvm/internal/impl/types/TypeProjectionImpl;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V
    ...
    .line 88
    .end local v2    # "approximation":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    :cond_3
    if-eqz p1, :cond_4
    ...
    .line 91
    .local v2, "approximation":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    new-instance v3, Lkotlin/reflect/jvm/internal/impl/types/TypeProjectionImpl;

    invoke-direct {v3, v1, v2}, Lkotlin/reflect/jvm/internal/impl/types/TypeProjectionImpl;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V
    ...
    .line 94
    .end local v2    # "approximation":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    :cond_4
...
.method private static final approximateProjection(Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;)Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    .local v1, "inLower":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .local v3, "outLower":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 173
    .local v2, "outUpper":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    new-instance v4, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;
    ...
    .line 175
    new-instance v6, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;

    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;->getTypeParameter()Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;

    move-result-object v7

    invoke-direct {v6, v7, v1, v2}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V

    .line 173
    invoke-direct {v4, v5, v6}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/ApproximationBounds;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static final replaceTypeArguments(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Ljava/util/List;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .locals 14
    .param p0, "$this$replaceTypeArguments"    # Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .local v7, "it":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    const/4 v8, 0x0

    .line 167
    .local v8, "$i$a$-map-CapturedTypeApproximationKt$replaceTypeArguments$2":I
    invoke-static {v7}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/CapturedTypeApproximationKt;->toTypeProjection(Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;)Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;

    move-result-object v7

    .line 185
    .end local v7    # "it":Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    .end local v8    # "$i$a$-map-CapturedTypeApproximationKt$replaceTypeArguments$2":I
    ...
    .line 166
    .local v0, "$i$a$-assert-CapturedTypeApproximationKt$replaceTypeArguments$1":I
    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Incorrect type arguments "
    ...
    .end local v0    # "$i$a$-assert-CapturedTypeApproximationKt$replaceTypeArguments$1":I
...
.method private static final toTypeArgument(Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;)Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    .locals 4
    .param p0, "$this$toTypeArgument"    # Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    invoke-direct {v0, p1, v2, v3}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V
    ...
    invoke-direct {v0, p1, v2, v1}, Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V
...
.method private static final toTypeProjection(Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;)Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    .locals 4
    .param p0, "$this$toTypeProjection"    # Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
    ...
    .line 47
    .local v0, "$i$a$-assert-CapturedTypeApproximationKt$toTypeProjection$1":I
    ...
    .line 50
    .local v1, "descriptorRenderer":Lkotlin/reflect/jvm/internal/impl/renderer/DescriptorRenderer;
    ...
    invoke-virtual {v1, v3}, Lkotlin/reflect/jvm/internal/impl/renderer/DescriptorRenderer;->render(Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;)Ljava/lang/String;
    ...
    .line 46
    .end local v0    # "$i$a$-assert-CapturedTypeApproximationKt$toTypeProjection$1":I
    .end local v1    # "descriptorRenderer":Lkotlin/reflect/jvm/internal/impl/renderer/DescriptorRenderer;
    new-instance v1, Ljava/lang/AssertionError;
...
.method private static final toTypeProjection$removeProjectionIfRedundant(Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lkotlin/reflect/jvm/internal/impl/types/Variance;
    .locals 1
    .param p0, "$this_toTypeProjection"    # Lkotlin/reflect/jvm/internal/impl/types/typesApproximation/TypeArgument;
