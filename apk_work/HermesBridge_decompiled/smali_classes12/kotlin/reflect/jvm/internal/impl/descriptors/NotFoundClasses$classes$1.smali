...
.method public final invoke(Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses$ClassRequest;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    .line 34
    .local p1, "typeParametersCount":Ljava/util/List;
    ...
    .local v1, "outerClassId":Lkotlin/reflect/jvm/internal/impl/name/ClassId;
    const/4 v3, 0x0

    .line 39
    .local v3, "$i$a$-let-NotFoundClasses$classes$1$container$1":I
    move-object v4, p1
    ...
    invoke-virtual {v2, v1, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses;->getClass(Lkotlin/reflect/jvm/internal/impl/name/ClassId;Ljava/util/List;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;

    move-result-object v1

    .line 38
    .end local v1    # "outerClassId":Lkotlin/reflect/jvm/internal/impl/name/ClassId;
    .end local v3    # "$i$a$-let-NotFoundClasses$classes$1$container$1":I
    if-eqz v1, :cond_0
    ...
    .line 43
    .local v1, "container":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassOrPackageFragmentDescriptor;
    ...
    .line 45
    .local v8, "isInner":Z
    new-instance v9, Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses$MockClassDescriptor;
    ...
    const-string v2, "classId.shortClassName"
    ...
    .line 35
    .end local v1    # "container":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassOrPackageFragmentDescriptor;
    ...
    const-string v3, "Unresolved local class: "
