...
.method public static final mapType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;Lkotlin/jvm/functions/Function3;)Ljava/lang/Object;
    ...
    .line 41
    invoke-interface {v9, v0}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;->preprocessType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 42
    .local v12, "$i$a$-let-DescriptorBasedTypeSignatureMappingKt$mapType$1":I
    ...
    .end local v12    # "$i$a$-let-DescriptorBasedTypeSignatureMappingKt$mapType$1":I
    :cond_0
    ...
    .local v1, "$this$mapType_u24lambda_u241":Lkotlin/reflect/jvm/internal/impl/types/checker/SimpleClassicTypeSystemContext;
    const/4 v2, 0x0

    .line 53
    .local v2, "$i$a$-with-DescriptorBasedTypeSignatureMappingKt$mapType$2":I
    move-object v3, v1

    check-cast v3, Lkotlin/reflect/jvm/internal/impl/types/TypeSystemCommonBackendContext;

    move-object v4, v0

    check-cast v4, Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;

    invoke-static {v3, v4, v7, v8}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeSignatureMappingKt;->mapBuiltInType(Lkotlin/reflect/jvm/internal/impl/types/TypeSystemCommonBackendContext;Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;)Ljava/lang/Object;

    move-result-object v1

    .line 52
    .end local v1    # "$this$mapType_u24lambda_u241":Lkotlin/reflect/jvm/internal/impl/types/checker/SimpleClassicTypeSystemContext;
    .end local v2    # "$i$a$-with-DescriptorBasedTypeSignatureMappingKt$mapType$2":I
    nop
    ...
    .local v1, "builtInType":Ljava/lang/Object;
    const/4 v2, 0x0

    .line 55
    .local v2, "$i$a$-let-DescriptorBasedTypeSignatureMappingKt$mapType$3":I
    invoke-virtual/range {p2 .. p2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;->getNeedPrimitiveBoxing()Z

    move-result v3

    invoke-static {v7, v1, v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeSignatureMappingKt;->boxTypeIfNeeded(Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;Ljava/lang/Object;Z)Ljava/lang/Object;

    move-result-object v3

    .line 56
    .local v3, "jvmType":Ljava/lang/Object;
    ...
    .line 60
    .end local v1    # "builtInType":Ljava/lang/Object;
    .end local v2    # "$i$a$-let-DescriptorBasedTypeSignatureMappingKt$mapType$3":I
    .end local v3    # "jvmType":Ljava/lang/Object;
    :cond_2
    ...
    .line 61
    .local v12, "constructor":Lkotlin/reflect/jvm/internal/impl/types/TypeConstructor;
    instance-of v1, v12, Lkotlin/reflect/jvm/internal/impl/types/IntersectionTypeConstructor;
    ...
    invoke-interface {v9, v1}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;->commonSupertype(Ljava/util/Collection;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 71
    .local v13, "intersectionType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    invoke-static {v13}, Lkotlin/reflect/jvm/internal/impl/types/typeUtil/TypeUtilsKt;->replaceArgumentsWithStarProjections(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 77
    .end local v13    # "intersectionType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    :cond_4
    ...
    .line 80
    .local v13, "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassifierDescriptor;
    nop
    ...
    invoke-interface {v7, v1}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;->createObjectType(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    .line 83
    .local v1, "jvmType":Ljava/lang/Object;
    move-object v2, v13

    check-cast v2, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;

    invoke-interface {v9, v0, v2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;->processErrorType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)V

    .line 84
    if-eqz v10, :cond_5

    invoke-virtual {v10, v1}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;->writeClass(Ljava/lang/Object;)V
    ...
    .line 88
    .end local v1    # "jvmType":Ljava/lang/Object;
    :cond_6
    instance-of v1, v13, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    .line 93
    .local v14, "memberProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    ...
    .local v1, "memberType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    const/4 v15, 0x0
    ...
    invoke-interface {v7, v2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;->createObjectType(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v2

    .line 98
    .end local v15    # "arrayElementType":Ljava/lang/Object;
    .local v2, "arrayElementType":Ljava/lang/Object;
    if-eqz v10, :cond_9

    move-object/from16 v3, p4

    .local v3, "$this$mapType_u24lambda_u243":Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;
    const/4 v4, 0x0

    .line 99
    .local v4, "$i$a$-apply-DescriptorBasedTypeSignatureMappingKt$mapType$4":I
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;->writeArrayType()V

    .line 100
    invoke-virtual {v3, v2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;->writeClass(Ljava/lang/Object;)V

    .line 101
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;->writeArrayEnd()V

    .line 102
    nop

    .line 98
    .end local v3    # "$this$mapType_u24lambda_u243":Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;
    .end local v4    # "$i$a$-apply-DescriptorBasedTypeSignatureMappingKt$mapType$4":I
    goto :goto_0

    .line 104
    .end local v2    # "arrayElementType":Ljava/lang/Object;
    ...
    invoke-virtual {v8, v3, v2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;->toGenericArgumentMode(Lkotlin/reflect/jvm/internal/impl/types/Variance;Z)Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;
    ...
    .line 111
    .end local v15    # "arrayElementType":Ljava/lang/Object;
    .restart local v2    # "arrayElementType":Ljava/lang/Object;
    if-eqz v10, :cond_9
    ...
    invoke-interface {v7, v2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;->toString(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v7, v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;->createFromString(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 90
    .end local v1    # "memberType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v2    # "arrayElementType":Ljava/lang/Object;
    .end local v14    # "memberProjection":Lkotlin/reflect/jvm/internal/impl/types/TypeProjection;
    :cond_a
    new-instance v1, Ljava/lang/UnsupportedOperationException;

    const-string v2, "arrays must have one type argument"
    ...
    invoke-static {v1, v2}, Lkotlin/reflect/jvm/internal/impl/types/ExpandedTypeUtilsKt;->computeExpandedTypeForInlineClass(Lkotlin/reflect/jvm/internal/impl/types/TypeSystemCommonBackendContext;Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;)Lkotlin/reflect/jvm/internal/impl/types/model/KotlinTypeMarker;
    ...
    .line 121
    .local v14, "expandedType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    if-eqz v14, :cond_c
    ...
    .line 130
    .end local v14    # "expandedType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    :cond_c
    ...
    invoke-static {v1}, Lkotlin/reflect/jvm/internal/impl/builtins/KotlinBuiltIns;->isKClass(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Z
    ...
    const-string v2, "descriptor.original"

    invoke-static {v1, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {v9, v1}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;->getPredefinedTypeForClass(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Ljava/lang/Object;
    ...
    .line 137
    .local v1, "$i$a$-run-DescriptorBasedTypeSignatureMappingKt$mapType$jvmType$1":I
    move-object v2, v13
    ...
    .line 141
    .local v2, "enumClassIfEnumEntry":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    invoke-static {v3, v9}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/DescriptorBasedTypeSignatureMappingKt;->computeInternalName(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingConfiguration;)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v7, v3}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmTypeFactory;->createObjectType(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    .line 134
    .end local v1    # "$i$a$-run-DescriptorBasedTypeSignatureMappingKt$mapType$jvmType$1":I
    .end local v2    # "enumClassIfEnumEntry":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    nop
    ...
    .line 145
    .local v1, "jvmType":Ljava/lang/Object;
    invoke-interface {v11, v0, v1, v8}, Lkotlin/jvm/functions/Function3;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v1    # "jvmType":Ljava/lang/Object;
    :cond_10
    instance-of v1, v13, Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;
    ...
    .line 153
    .local v14, "upperBound":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    invoke-interface {v13}, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassifierDescriptor;->getName()Lkotlin/reflect/jvm/internal/impl/name/Name;

    move-result-object v2

    const-string v3, "descriptor.getName()"

    invoke-static {v2, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v10, v2, v1}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/JvmDescriptorTypeWriter;->writeTypeVariable(Lkotlin/reflect/jvm/internal/impl/name/Name;Ljava/lang/Object;)V
    ...
    .end local v14    # "upperBound":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    :cond_13
    instance-of v1, v13, Lkotlin/reflect/jvm/internal/impl/descriptors/TypeAliasDescriptor;

    if-eqz v1, :cond_14

    invoke-virtual/range {p2 .. p2}, Lkotlin/reflect/jvm/internal/impl/load/kotlin/TypeMappingMode;->getMapTypeAliases()Z
    ...
    .line 78
    .end local v13    # "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/ClassifierDescriptor;
    :cond_15
    new-instance v1, Ljava/lang/UnsupportedOperationException;
