...
.method static constructor <clinit>()V
    ...
    .local v0, "$this$FAKE_CONTINUATION_CLASS_DESCRIPTOR_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/MutableClassDescriptor;
    const/4 v1, 0x0

    .line 34
    .local v1, "$i$a$-apply-SuspendFunctionTypesKt$FAKE_CONTINUATION_CLASS_DESCRIPTOR$1":I
    ...
    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/MutableClassDescriptor;->setModality(Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;)V
    ...
    sget-object v15, Lkotlin/reflect/jvm/internal/impl/storage/LockBasedStorageManager;->NO_LOCKS:Lkotlin/reflect/jvm/internal/impl/storage/StorageManager;
    ...
    .local v2, "p0":Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;
    const/4 v3, 0x0

    .line 39
    .local v3, "$i$a$-let-SuspendFunctionTypesKt$FAKE_CONTINUATION_CLASS_DESCRIPTOR$1$1":I
    invoke-static {v2}, Lkotlin/collections/CollectionsKt;->listOf(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v2

    .line 36
    .end local v2    # "p0":Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;
    .end local v3    # "$i$a$-let-SuspendFunctionTypesKt$FAKE_CONTINUATION_CLASS_DESCRIPTOR$1$1":I
    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/MutableClassDescriptor;->setTypeParameterDescriptors(Ljava/util/List;)V
    ...
    .line 33
    .end local v0    # "$this$FAKE_CONTINUATION_CLASS_DESCRIPTOR_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/MutableClassDescriptor;
    .end local v1    # "$i$a$-apply-SuspendFunctionTypesKt$FAKE_CONTINUATION_CLASS_DESCRIPTOR$1":I
...
.method public static final transformSuspendFunctionToRuntimeFunctionType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)Lkotlin/reflect/jvm/internal/impl/types/SimpleType;
    ...
    .line 54
    .local v12, "$i$a$-map-SuspendFunctionTypesKt$transformSuspendFunctionToRuntimeFunctionType$2":I
    ...
    .end local v12    # "$i$a$-map-SuspendFunctionTypesKt$transformSuspendFunctionToRuntimeFunctionType$2":I
    ...
    .line 46
    .local v0, "$i$a$-assert-SuspendFunctionTypesKt$transformSuspendFunctionToRuntimeFunctionType$1":I
    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "This type should be suspend function type: "
    ...
    .line 45
    .end local v0    # "$i$a$-assert-SuspendFunctionTypesKt$transformSuspendFunctionToRuntimeFunctionType$1":I
