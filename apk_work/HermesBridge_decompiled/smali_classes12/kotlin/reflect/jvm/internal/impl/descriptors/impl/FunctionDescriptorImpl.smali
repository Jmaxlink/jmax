...
.method protected constructor <init>(Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;Lkotlin/reflect/jvm/internal/impl/name/Name;Lkotlin/reflect/jvm/internal/impl/descriptors/CallableMemberDescriptor$Kind;Lkotlin/reflect/jvm/internal/impl/descriptors/SourceElement;)V
    ...
    .line 32
    sget-object v2, Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibilities;->UNKNOWN:Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;

    iput-object v2, p0, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->visibility:Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;
    ...
    :goto_0
    iput-object v0, p0, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->original:Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
...
.method private getSourceToUseForCopy(ZLkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;)Lkotlin/reflect/jvm/internal/impl/descriptors/SourceElement;
    ...
    :goto_0
    invoke-interface {v0}, Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;->getSource()Lkotlin/reflect/jvm/internal/impl/descriptors/SourceElement;
...
.method public static getSubstitutedValueParameters(Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;ZZ[Z)Ljava/util/List;
    ...
    .line 843
    .local v1, "result":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;>;"
    ...
    .line 845
    .local v3, "unsubstitutedValueParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;
    ...
    .line 847
    .local v5, "varargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    const/4 v6, 0x0
    ...
    .line 849
    .local v15, "substituteVarargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    if-nez v4, :cond_3
    ...
    .line 857
    .local v7, "destructuringVariablesAction":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;>;"
    instance-of v8, v3, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/ValueParameterDescriptorImpl$WithDestructuringDeclaration;
    ...
    check-cast v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/ValueParameterDescriptorImpl$WithDestructuringDeclaration;

    .line 860
    invoke-virtual {v8}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/ValueParameterDescriptorImpl$WithDestructuringDeclaration;->getDestructuringVariables()Ljava/util/List;

    move-result-object v8

    .line 861
    .local v8, "destructuringVariables":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;"
    new-instance v9, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$2;

    invoke-direct {v9, v8}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$2;-><init>(Ljava/util/List;)V
    ...
    .line 857
    .end local v8    # "destructuringVariables":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;"
    :cond_6
    move-object/from16 v18, v7

    .line 869
    .end local v7    # "destructuringVariablesAction":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;>;"
    .local v18, "destructuringVariablesAction":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;>;"
    :goto_2
    if-eqz p3, :cond_7
    ...
    .end local v15    # "substituteVarargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .local v19, "substituteVarargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 885
    .end local v3    # "unsubstitutedValueParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;
    .end local v4    # "substitutedType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v5    # "varargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v18    # "destructuringVariablesAction":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/VariableDescriptor;>;>;"
    .end local v19    # "substituteVarargElementType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    goto/16 :goto_0
...
.method protected doSubstitute(Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;)Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    ...
    .line 613
    .local v5, "resultAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 617
    .local v0, "substitutedDescriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;
    nop
    ...
    .line 620
    .local v1, "unsubstitutedTypeParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;>;"
    :goto_1
    const/4 v2, 0x0

    aget-boolean v3, v15, v2
    ...
    .line 624
    .local v3, "substitutedTypeParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;>;"
    iget-object v4, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->substitution:Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitution;

    invoke-static {v1, v4, v0, v3, v15}, Lkotlin/reflect/jvm/internal/impl/types/DescriptorSubstitutor;->substituteTypeParameters(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitution;Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;Ljava/util/List;[Z)Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;
    ...
    .line 630
    .local v14, "substitutedContextReceiverParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;>;"
    iget-object v10, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newContextReceiverParameters:Ljava/util/List;
    ...
    .line 632
    .local v10, "index":I
    iget-object v11, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newContextReceiverParameters:Ljava/util/List;
    ...
    check-cast v12, Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;

    .line 633
    .local v12, "newContextReceiverParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    nop

    .line 634
    invoke-interface {v12}, Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;->getType()Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    invoke-virtual {v4, v13, v9}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->substitute(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;

    move-result-object v9

    .line 635
    .local v9, "substitutedContextReceiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    if-nez v9, :cond_4
    ...
    .line 640
    invoke-interface {v12}, Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;->getValue()Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ReceiverValue;

    move-result-object v13

    check-cast v13, Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ImplicitContextReceiver;

    invoke-interface {v13}, Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ImplicitContextReceiver;->getCustomLabelName()Lkotlin/reflect/jvm/internal/impl/name/Name;

    move-result-object v13

    .line 641
    invoke-interface {v12}, Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;->getAnnotations()Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 646
    .end local v6    # "substitutedContextReceiverParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    .end local v9    # "substitutedContextReceiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v12    # "newContextReceiverParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    move/from16 v10, v17
    ...
    .line 650
    .local v6, "substitutedReceiverParameter":Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    iget-object v9, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newExtensionReceiverParameter:Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    invoke-virtual {v4, v9, v10}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->substitute(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;

    move-result-object v9

    .line 653
    .local v9, "substitutedExtensionReceiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    if-nez v9, :cond_7
    ...
    new-instance v11, Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ExtensionReceiver;

    iget-object v12, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newExtensionReceiverParameter:Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    invoke-direct {v11, v0, v9, v12}, Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ExtensionReceiver;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ReceiverValue;)V
    ...
    invoke-direct {v10, v0, v11, v12}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/ReceiverParameterDescriptorImpl;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;Lkotlin/reflect/jvm/internal/impl/resolve/scopes/receivers/ReceiverValue;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)V
    ...
    iget-object v11, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newExtensionReceiverParameter:Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    .line 667
    .end local v9    # "substitutedExtensionReceiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    :cond_9
    const/4 v9, 0x0

    .line 668
    .local v9, "substitutedExpectedThis":Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    iget-object v10, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->dispatchReceiverParameter:Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    invoke-interface {v10, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;->substitute(Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    iget-object v11, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->dispatchReceiverParameter:Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    ...
    .line 687
    :cond_c
    iget-object v11, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newValueParameterDescriptors:Ljava/util/List;

    iget-boolean v13, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->dropOriginalInContainingParts:Z

    iget-boolean v12, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->preserveSourceElement:Z
    ...
    .end local v14    # "substitutedContextReceiverParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;>;"
    .local v25, "substitutedContextReceiverParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;>;"
    move/from16 v14, v17

    move-object/from16 v26, v15

    .end local v15    # "wereChanges":[Z
    .local v26, "wereChanges":[Z
    invoke-static/range {v10 .. v15}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->getSubstitutedValueParameters(Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;ZZ[Z)Ljava/util/List;

    move-result-object v10

    .line 691
    .local v10, "substitutedValueParameters":Ljava/util/List;, "Ljava/util/List<Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;>;"
    if-nez v10, :cond_d
    ...
    iget-object v12, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newReturnType:Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    invoke-virtual {v4, v12, v13}, Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;->substitute(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/types/Variance;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;

    move-result-object v12

    .line 696
    .local v12, "substitutedReturnType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    if-nez v12, :cond_e
    ...
    .line 700
    :cond_e
    aget-boolean v11, v26, v2

    iget-object v13, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newReturnType:Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    iget-object v11, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->newVisibility:Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;
    ...
    .line 714
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isOperator:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setOperator(Z)V

    .line 715
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isInfix:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setInfix(Z)V

    .line 716
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isExternal:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setExternal(Z)V

    .line 717
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isInline:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setInline(Z)V

    .line 718
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isTailrec:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setTailrec(Z)V

    .line 719
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isSuspend:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setSuspend(Z)V

    .line 720
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isExpect:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setExpect(Z)V

    .line 721
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->isActual:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setActual(Z)V

    .line 722
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->hasStableParameterNames:Z

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setHasStableParameterNames(Z)V
    ...
    invoke-direct {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setHiddenToOvercomeSignatureClash(Z)V
    ...
    invoke-direct {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setHiddenForResolutionEverywhereBesideSupercalls(Z)V
    ...
    :cond_11
    iget-boolean v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->hasSynthesizedParameterNames:Z

    .line 726
    :goto_7
    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setHasSynthesizedParameterNames(Z)V
    ...
    iget-object v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->userDataMap:Ljava/util/Map;
    ...
    .line 733
    .local v2, "newMap":Ljava/util/Map;, "Ljava/util/Map<Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor$UserDataKey<*>;Ljava/lang/Object;>;"
    iget-object v11, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->userDataMap:Ljava/util/Map;
    ...
    .line 735
    .local v13, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor$UserDataKey<*>;Ljava/lang/Object;>;"
    ...
    .line 738
    .end local v13    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor$UserDataKey<*>;Ljava/lang/Object;>;"
    :cond_13
    goto :goto_8
    ...
    .line 743
    invoke-static {v11, v13}, Ljava/util/Collections;->singletonMap(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v11

    iput-object v11, v0, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->userDataMap:Ljava/util/Map;

    goto :goto_9

    .line 747
    :cond_15
    iput-object v2, v0, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->userDataMap:Ljava/util/Map;

    .line 751
    .end local v2    # "newMap":Ljava/util/Map;, "Ljava/util/Map<Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor$UserDataKey<*>;Ljava/lang/Object;>;"
    :cond_16
    :goto_9
    iget-boolean v2, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->signatureChange:Z
    ...
    .line 753
    .local v2, "initialSignature":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    :goto_a
    invoke-interface {v2, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;->substitute(Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;)Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;

    move-result-object v11

    .line 754
    .local v11, "initialSignatureSubstituted":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    invoke-direct {v0, v11}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setInitialSignatureDescriptor(Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;)V

    .line 757
    .end local v2    # "initialSignature":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    .end local v11    # "initialSignatureSubstituted":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    :cond_19
    iget-boolean v2, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->copyOverrides:Z
    ...
    .line 758
    iget-object v2, v8, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$CopyConfiguration;->substitution:Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitution;
    ...
    .line 759
    iget-object v2, v7, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->lazyOverriddenFunctionsTask:Lkotlin/jvm/functions/Function0;

    .line 760
    .local v2, "overriddenFunctionsTask":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/Collection<Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;>;>;"
    if-eqz v2, :cond_1a

    .line 761
    iput-object v2, v0, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->lazyOverriddenFunctionsTask:Lkotlin/jvm/functions/Function0;
    ...
    invoke-virtual {v0, v11}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;->setOverriddenDescriptors(Ljava/util/Collection;)V

    .line 766
    .end local v2    # "overriddenFunctionsTask":Lkotlin/jvm/functions/Function0;, "Lkotlin/jvm/functions/Function0<Ljava/util/Collection<Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;>;>;"
    :goto_b
    goto :goto_c
    ...
    invoke-direct {v2, v7, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl$1;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;Lkotlin/reflect/jvm/internal/impl/types/TypeSubstitutor;)V
...
.method public initialize(Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;)Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FunctionDescriptorImpl;
    ...
    const-string v2, " but position is "
    ...
    .line 93
    .restart local v1    # "typeParameterDescriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/TypeParameterDescriptor;
    :cond_4
    ...
    .line 100
    .local v1, "firstValueParameterOffset":I
    ...
    .line 97
    .end local v1    # "firstValueParameterOffset":I
    ...
    .line 102
    .restart local v1    # "firstValueParameterOffset":I
    .restart local v3    # "valueParameterDescriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;
    :cond_6
...
.method public isInfix()Z
    ...
    .line 238
    .local v2, "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    ...
    .line 239
    .end local v2    # "descriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    :cond_1
    goto :goto_0
...
.method public setOverriddenDescriptors(Ljava/util/Collection;)V
    ...
    invoke-interface {v1}, Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;->isHiddenForResolutionEverywhereBesideSupercalls()Z
    ...
    .line 295
    .end local v1    # "function":Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;
    :cond_1
    goto :goto_0
