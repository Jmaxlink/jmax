...
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;)V
    ...
    .param p3, "ownerDescriptor"    # Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;
...
.method private static final flatMapJavaStaticSupertypesScopes$lambda$6(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Ljava/lang/Iterable;
    .locals 2
    .param p0, "it"    # Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$flatMapJavaStaticSupertypesScopes$1$1;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$flatMapJavaStaticSupertypesScopes$1$1;
...
.method private final getRealOriginal(Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;)Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    .locals 10
    .param p1, "$this$realOriginal"    # Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    ...
    .line 168
    .local v8, "$i$a$-map-LazyJavaStaticClassScope$realOriginal$1":I
    const-string v9, "it"

    invoke-static {v7, v9}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {p0, v7}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getRealOriginal(Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;)Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;

    move-result-object v7

    .line 195
    .end local v7    # "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    .end local v8    # "$i$a$-map-LazyJavaStaticClassScope$realOriginal$1":I
...
.method protected computeFunctionNames(Lkotlin/reflect/jvm/internal/impl/resolve/scopes/DescriptorKindFilter;Lkotlin/jvm/functions/Function1;)Ljava/util/Set;
    ...
    .local v1, "$this$computeFunctionNames_u24lambda_u241":Ljava/util/Set;
    const/4 v2, 0x0

    .line 48
    .local v2, "$i$a$-apply-LazyJavaStaticClassScope$computeFunctionNames$1":I
    ...
    invoke-static {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/UtilKt;->getParentJavaStaticClassScope(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getFunctionNames()Ljava/util/Set;
    ...
    .line 49
    iget-object v3, p0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->jClass:Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;

    invoke-interface {v3}, Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;->isEnum()Z
    ...
    filled-new-array {v3, v4}, [Lkotlin/reflect/jvm/internal/impl/name/Name;
    ...
    .line 172
    .local v3, "$this$computeFunctionNames_u24lambda_u241_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    const/4 v4, 0x0

    .line 52
    .local v4, "$i$a$-with-LazyJavaStaticClassScope$computeFunctionNames$1$1":I
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getC()Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    ...
    invoke-interface {v5, v3, v6}, Lkotlin/reflect/jvm/internal/impl/resolve/jvm/SyntheticJavaPartsProvider;->getStaticFunctionNames(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Ljava/util/List;
    ...
    .line 53
    .end local v3    # "$this$computeFunctionNames_u24lambda_u241_u24lambda_u240":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    .end local v4    # "$i$a$-with-LazyJavaStaticClassScope$computeFunctionNames$1$1":I
    nop

    .line 47
    .end local v1    # "$this$computeFunctionNames_u24lambda_u241":Ljava/util/Set;
    .end local v2    # "$i$a$-apply-LazyJavaStaticClassScope$computeFunctionNames$1":I
    nop
...
.method protected computeImplicitlyDeclaredFunctions(Ljava/util/Collection;Lkotlin/reflect/jvm/internal/impl/name/Name;)V
    ...
    .line 172
    .local v0, "$this$computeImplicitlyDeclaredFunctions_u24lambda_u243":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    const/4 v1, 0x0

    .line 92
    .local v1, "$i$a$-with-LazyJavaStaticClassScope$computeImplicitlyDeclaredFunctions$1":I
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getC()Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    ...
    .line 93
    .end local v0    # "$this$computeImplicitlyDeclaredFunctions_u24lambda_u243":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    .end local v1    # "$i$a$-with-LazyJavaStaticClassScope$computeImplicitlyDeclaredFunctions$1":I
    return-void
.end method
...
.method protected computeNonDeclaredProperties(Lkotlin/reflect/jvm/internal/impl/name/Name;Ljava/util/Collection;)V
    ...
    .line 96
    invoke-virtual/range {p0 .. p0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getOwnerDescriptor()Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;
    ...
    new-instance v3, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$computeNonDeclaredProperties$propertiesFromSupertypes$1;

    invoke-direct {v3, v7}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$computeNonDeclaredProperties$propertiesFromSupertypes$1;-><init>(Lkotlin/reflect/jvm/internal/impl/name/Name;)V

    check-cast v3, Lkotlin/jvm/functions/Function1;

    invoke-direct {v0, v1, v2, v3}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->flatMapJavaStaticSupertypesScopes(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;Ljava/util/Set;Lkotlin/jvm/functions/Function1;)Ljava/util/Set;

    move-result-object v9

    .line 100
    .local v9, "propertiesFromSupertypes":Ljava/util/Set;
    ...
    .local v12, "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    const/4 v13, 0x0

    .line 113
    .local v13, "$i$a$-groupBy-LazyJavaStaticClassScope$computeNonDeclaredProperties$1":I
    invoke-direct {v0, v12}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getRealOriginal(Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;)Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;

    move-result-object v12

    .line 175
    .end local v12    # "it":Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    .end local v13    # "$i$a$-groupBy-LazyJavaStaticClassScope$computeNonDeclaredProperties$1":I
    nop
    ...
    .local v11, "$this$flatMap$iv":Ljava/util/Map;
    const/4 v12, 0x0
    ...
    .local v13, "$this$flatMapTo$iv$iv":Ljava/util/Map;
    move-object v14, v1
    ...
    .line 189
    .local v17, "element$iv$iv":Ljava/util/Map$Entry;
    ...
    .line 116
    .local v19, "$i$a$-flatMap-LazyJavaStaticClassScope$computeNonDeclaredProperties$2":I
    ...
    .end local v19    # "$i$a$-flatMap-LazyJavaStaticClassScope$computeNonDeclaredProperties$2":I
    check-cast v1, Ljava/lang/Iterable;

    .line 190
    .local v1, "list$iv$iv":Ljava/lang/Iterable;
    invoke-static {v14, v1}, Lkotlin/collections/CollectionsKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    goto :goto_2

    .line 192
    .end local v1    # "list$iv$iv":Ljava/lang/Iterable;
    .end local v17    # "element$iv$iv":Ljava/util/Map$Entry;
    :cond_3
    nop

    .end local v13    # "$this$flatMapTo$iv$iv":Ljava/util/Map;
    .end local v14    # "destination$iv$iv":Ljava/util/Collection;
    .end local v15    # "$i$f$flatMapTo":I
    move-object v1, v14
    ...
    .end local v11    # "$this$flatMap$iv":Ljava/util/Map;
    ...
    .line 121
    :goto_3
    iget-object v1, v0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->jClass:Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;
    ...
    .line 123
    sget-object v1, Lkotlin/reflect/jvm/internal/impl/builtins/StandardNames;->ENUM_ENTRIES:Lkotlin/reflect/jvm/internal/impl/name/Name;
    ...
    invoke-static {v1}, Lkotlin/reflect/jvm/internal/impl/resolve/DescriptorFactory;->createEnumEntriesProperty(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;)Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;

    move-result-object v1

    invoke-static {v8, v1}, Lkotlin/reflect/jvm/internal/impl/utils/CollectionsKt;->addIfNotNull(Ljava/util/Collection;Ljava/lang/Object;)V
...
.method protected computePropertyNames(Lkotlin/reflect/jvm/internal/impl/resolve/scopes/DescriptorKindFilter;Lkotlin/jvm/functions/Function1;)Ljava/util/Set;
    ...
    .local v1, "$this$computePropertyNames_u24lambda_u242":Ljava/util/Set;
    const/4 v2, 0x0

    .line 57
    .local v2, "$i$a$-apply-LazyJavaStaticClassScope$computePropertyNames$1":I
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->getOwnerDescriptor()Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;
    ...
    sget-object v4, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$computePropertyNames$1$1;->INSTANCE:Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope$computePropertyNames$1$1;

    check-cast v4, Lkotlin/jvm/functions/Function1;

    invoke-direct {p0, v3, v1, v4}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaStaticClassScope;->flatMapJavaStaticSupertypesScopes(Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;Ljava/util/Set;Lkotlin/jvm/functions/Function1;)Ljava/util/Set;
    ...
    .line 59
    sget-object v3, Lkotlin/reflect/jvm/internal/impl/builtins/StandardNames;->ENUM_ENTRIES:Lkotlin/reflect/jvm/internal/impl/name/Name;
    ...
    .line 56
    .end local v1    # "$this$computePropertyNames_u24lambda_u242":Ljava/util/Set;
    .end local v2    # "$i$a$-apply-LazyJavaStaticClassScope$computePropertyNames$1":I
    nop
