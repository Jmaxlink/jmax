...
.method public getType(Lkotlin/reflect/jvm/internal/impl/descriptors/ModuleDescriptor;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    ...
    .line 321
    .local v2, "p0":Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;
    const/4 v3, 0x0

    .line 125
    .local v3, "$i$a$-takeIf-EnumValue$getType$1":I
    invoke-static {v2}, Lkotlin/reflect/jvm/internal/impl/resolve/DescriptorUtils;->isEnumClass(Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;)Z

    move-result v2

    .end local v2    # "p0":Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;
    .end local v3    # "$i$a$-takeIf-EnumValue$getType$1":I
    if-eqz v2, :cond_0
    ...
    .line 126
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/types/error/ErrorTypeKind;->ERROR_ENUM_TYPE:Lkotlin/reflect/jvm/internal/impl/types/error/ErrorTypeKind;
