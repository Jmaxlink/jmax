...
.method private final asProtoContainer(Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;)Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoContainer;
    .locals 5
    .param p1, "$this$asProtoContainer"    # Lkotlin/reflect/jvm/internal/impl/descriptors/DeclarationDescriptor;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoContainer$Package;-><init>(Lkotlin/reflect/jvm/internal/impl/name/FqName;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/NameResolver;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;Lkotlin/reflect/jvm/internal/impl/descriptors/SourceElement;)V
...
.method private final initializeWithCoroutinesExperimentalityStatus(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedSimpleFunctionDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;Ljava/util/Map;)V
    .locals 0
    .param p1, "$this$initializeWithCoroutinesExperimentalityStatus"    # Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedSimpleFunctionDescriptor;
    .param p2, "extensionReceiverParameter"    # Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    .param p3, "dispatchReceiverParameter"    # Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    .param p4, "contextReceiverParameters"    # Ljava/util/List;
    .param p5, "typeParameters"    # Ljava/util/List;
    .param p6, "unsubstitutedValueParameters"    # Ljava/util/List;
    .param p7, "unsubstitutedReturnType"    # Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .param p8, "modality"    # Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;
    .param p9, "visibility"    # Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;
    .param p10, "userDataMap"    # Ljava/util/Map;
...
.method private final toContextReceiver(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;I)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;
    .locals 3
    .param p1, "$this$toContextReceiver"    # Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .param p2, "deserializationContext"    # Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .param p3, "callableDescriptor"    # Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;
    .param p4, "index"    # I
    ...
    invoke-virtual {v0, p1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;->type(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;)Lkotlin/reflect/jvm/internal/impl/types/KotlinType;

    move-result-object v0

    .line 363
    .local v0, "contextReceiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    nop
...
.method private final valueParameters(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Ljava/util/List;
    ...
    .line 325
    .local v20, "callableDescriptor":Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;
    ...
    .line 327
    .local v21, "containerOfCallable":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoContainer;
    move-object/from16 v15, p1

    check-cast v15, Ljava/lang/Iterable;

    .local v15, "$this$mapIndexed$iv":Ljava/lang/Iterable;
    const/16 v22, 0x0

    .line 398
    .local v22, "$i$f$mapIndexed":I
    ...
    .local v23, "$this$mapIndexedTo$iv$iv":Ljava/lang/Iterable;
    move-object v14, v0
    ...
    .local v5, "i":I
    .local v13, "proto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;
    const/16 v28, 0x0

    .line 328
    .local v28, "$i$a$-mapIndexed-MemberDeserializer$valueParameters$1":I
    invoke-virtual {v13}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;->hasFlags()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {v13}, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;->getFlags()I
    ...
    invoke-virtual {v0, v11}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    .line 330
    new-instance v8, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/NonEmptyDeserializedAnnotations;
    ...
    .line 329
    new-instance v10, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer$valueParameters$1$annotations$1;
    ...
    .line 330
    invoke-direct {v8, v9, v10}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/NonEmptyDeserializedAnnotations;-><init>(Lkotlin/reflect/jvm/internal/impl/storage/StorageManager;Lkotlin/jvm/functions/Function0;)V
    ...
    .line 337
    .local v12, "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    nop
    ...
    invoke-static {v13, v2}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->type(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    ...
    invoke-virtual {v2, v11}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    invoke-virtual {v3, v11}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    invoke-static {v13, v3}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->varargElementType(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    ...
    .local v3, "it":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    const/4 v4, 0x0

    .line 344
    .local v4, "$i$a$-let-MemberDeserializer$valueParameters$1$1":I
    iget-object v6, v7, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->c:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;

    invoke-virtual {v6}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;->getTypeDeserializer()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;
    ...
    .end local v3    # "it":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .end local v4    # "$i$a$-let-MemberDeserializer$valueParameters$1$1":I
    goto :goto_3
    ...
    .end local v13    # "proto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;
    .local v29, "proto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;
    move-object v13, v0
    ...
    .end local v15    # "$this$mapIndexed$iv":Ljava/lang/Iterable;
    ...
    .end local v12    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .end local v28    # "$i$a$-mapIndexed-MemberDeserializer$valueParameters$1":I
    .end local v29    # "proto":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$ValueParameter;
    ...
    .restart local v15    # "$this$mapIndexed$iv":Ljava/lang/Iterable;
    :cond_4
    move-object v0, v14

    .end local v5    # "index$iv$iv":I
    .end local v14    # "destination$iv$iv":Ljava/util/Collection;
    .end local v23    # "$this$mapIndexedTo$iv$iv":Ljava/lang/Iterable;
    .end local v24    # "$i$f$mapIndexedTo":I
    ...
    .end local v15    # "$this$mapIndexed$iv":Ljava/lang/Iterable;
    .end local v22    # "$i$f$mapIndexed":I
...
.method public final loadConstructor(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Constructor;Z)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassConstructorDescriptor;
    ...
    new-instance v17, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassConstructorDescriptor;
    ...
    .line 275
    .local v2, "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    nop
    ...
    invoke-direct {v3, v4, v5, v6}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->valueParameters(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassConstructorDescriptor;->setExpect(Z)V
    ...
    invoke-virtual {v1, v3}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedClassConstructorDescriptor;->setHasStableParameterNames(Z)V
...
.method public final loadFunction(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Function;)Lkotlin/reflect/jvm/internal/impl/descriptors/SimpleFunctionDescriptor;
    ...
    .line 194
    .local v26, "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 198
    .local v8, "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/VersionRequirementTable$Companion;->getEMPTY()Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/VersionRequirementTable;
    ...
    .line 202
    .local v21, "versionRequirementTable":Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/VersionRequirementTable;
    ...
    .line 208
    .local v12, "function":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedSimpleFunctionDescriptor;
    iget-object v0, v11, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->c:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    ...
    .line 210
    .local v13, "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    nop
    ...
    invoke-static {v10, v0}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->receiverType(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Function;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual {v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;->getTypeDeserializer()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;
    ...
    .local v0, "p0":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    const/4 v2, 0x0

    .line 211
    .local v2, "$i$a$-let-MemberDeserializer$loadFunction$1":I
    ...
    .end local v0    # "p0":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .end local v2    # "$i$a$-let-MemberDeserializer$loadFunction$1":I
    if-eqz v0, :cond_3

    .local v0, "receiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    const/4 v1, 0x0

    .line 212
    .local v1, "$i$a$-let-MemberDeserializer$loadFunction$2":I
    move-object v2, v12

    check-cast v2, Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;

    invoke-static {v2, v0, v8}, Lkotlin/reflect/jvm/internal/impl/resolve/DescriptorFactory;->createExtensionReceiverParameterForCallable(Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;

    move-result-object v0

    .line 211
    .end local v0    # "receiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v1    # "$i$a$-let-MemberDeserializer$loadFunction$2":I
    goto :goto_3
    ...
    .local v0, "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    const/4 v1, 0x0
    ...
    .line 388
    .local v20, "$i$a$-forEachIndexed-CollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$iv$iv":I
    move-object/from16 v22, v0

    .end local v0    # "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    .local v22, "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    move-object/from16 v0, v19

    check-cast v0, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;

    .local v0, "type":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    move/from16 v23, v15
    ...
    .line 215
    .local v24, "$i$a$-mapIndexedNotNull-MemberDeserializer$loadFunction$3":I
    move/from16 v25, v1

    .end local v1    # "$i$f$mapIndexedNotNull":I
    .local v25, "$i$f$mapIndexedNotNull":I
    move-object v1, v12
    ...
    .local v5, "index":I
    .local v27, "$this$mapIndexedNotNullTo$iv$iv":Ljava/lang/Iterable;
    invoke-direct {v11, v0, v13, v1, v5}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->toContextReceiver(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;I)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;

    move-result-object v0

    .line 388
    .end local v0    # "type":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .end local v5    # "index":I
    .end local v24    # "$i$a$-mapIndexedNotNull-MemberDeserializer$loadFunction$3":I
    if-eqz v0, :cond_5
    ...
    .end local v20    # "$i$a$-forEachIndexed-CollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$iv$iv":I
    :cond_5
    move/from16 v15, v18
    ...
    .end local v22    # "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    .end local v25    # "$i$f$mapIndexedNotNull":I
    .end local v27    # "$this$mapIndexedNotNullTo$iv$iv":Ljava/lang/Iterable;
    .local v0, "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    .local v1, "$i$f$mapIndexedNotNull":I
    .local v5, "$this$mapIndexedNotNullTo$iv$iv":Ljava/lang/Iterable;
    .local v15, "index$iv$iv$iv":I
    ...
    .end local v15    # "index$iv$iv$iv":I
    .restart local v22    # "$this$mapIndexedNotNull$iv":Ljava/lang/Iterable;
    .restart local v25    # "$i$f$mapIndexedNotNull":I
    .restart local v27    # "$this$mapIndexedNotNullTo$iv$iv":Ljava/lang/Iterable;
    nop
    ...
    .line 217
    invoke-virtual {v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;->getMemberDeserializer()Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;
    ...
    invoke-direct {v0, v1, v6, v7}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->valueParameters(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Ljava/util/List;
    ...
    .end local v8    # "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .local v17, "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    move-object v8, v14
    ...
    invoke-interface {v0, v15, v1, v2, v3}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ContractDeserializer;->deserializeContractFromFunction(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Function;Lkotlin/reflect/jvm/internal/impl/descriptors/FunctionDescriptor;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/TypeDeserializer;)Lkotlin/Pair;
    ...
    .line 234
    .local v0, "mapValueForContract":Lkotlin/Pair;
    if-eqz v0, :cond_7
    ...
    invoke-virtual {v12, v1, v2}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedSimpleFunctionDescriptor;->putInUserDataMap(Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor$UserDataKey;Ljava/lang/Object;)V
...
.method public final loadProperty(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;)Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    ...
    invoke-direct {v0, v4, v3, v5}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getAnnotations(Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;ILkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 48
    .local v1, "property":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;
    iget-object v2, v0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->c:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    ...
    invoke-direct {v0, v6, v7}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getReceiverParameterAnnotations(Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 56
    .local v6, "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    nop
    ...
    invoke-static {v5, v8}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->returnType(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    ...
    invoke-static {v5, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->receiverType(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    ...
    .local v7, "p0":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    const/4 v10, 0x0

    .line 60
    .local v10, "$i$a$-let-MemberDeserializer$loadProperty$1":I
    ...
    .end local v7    # "p0":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .end local v10    # "$i$a$-let-MemberDeserializer$loadProperty$1":I
    if-eqz v7, :cond_2

    .local v7, "receiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    const/4 v9, 0x0

    .line 61
    .local v9, "$i$a$-let-MemberDeserializer$loadProperty$2":I
    move-object v10, v1

    check-cast v10, Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;

    invoke-static {v10, v7, v6}, Lkotlin/reflect/jvm/internal/impl/resolve/DescriptorFactory;->createExtensionReceiverParameterForCallable(Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;

    move-result-object v7

    .line 60
    .end local v7    # "receiverType":Lkotlin/reflect/jvm/internal/impl/types/KotlinType;
    .end local v9    # "$i$a$-let-MemberDeserializer$loadProperty$2":I
    ...
    invoke-static {v5, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/ProtoTypeTableUtilKt;->contextReceiverTypes(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/TypeTable;)Ljava/util/List;

    move-result-object v7

    check-cast v7, Ljava/lang/Iterable;

    .local v7, "$this$mapIndexed$iv":Ljava/lang/Iterable;
    const/4 v9, 0x0
    ...
    .local v11, "$this$mapIndexedTo$iv$iv":Ljava/lang/Iterable;
    const/4 v12, 0x0
    ...
    .local v8, "type":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .local v13, "index":I
    const/16 v17, 0x0

    .line 63
    .local v17, "$i$a$-mapIndexed-MemberDeserializer$loadProperty$3":I
    move-object/from16 v21, v6

    .end local v6    # "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    invoke-direct {v0, v8, v2, v6, v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->toContextReceiver(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;Lkotlin/reflect/jvm/internal/impl/descriptors/CallableDescriptor;I)Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;

    move-result-object v6

    .line 376
    .end local v8    # "type":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Type;
    .end local v13    # "index":I
    .end local v17    # "$i$a$-mapIndexed-MemberDeserializer$loadProperty$3":I
    ...
    .restart local v6    # "receiverAnnotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .local v13, "index$iv$iv":I
    :cond_4
    move-object/from16 v21, v6
    ...
    .end local v11    # "$this$mapIndexedTo$iv$iv":Ljava/lang/Iterable;
    ...
    .line 56
    .end local v7    # "$this$mapIndexed$iv":Ljava/lang/Iterable;
    .end local v9    # "$i$f$mapIndexed":I
    move-object/from16 v23, v1

    invoke-virtual/range {v23 .. v28}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;->setType(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/ReceiverParameterDescriptor;Ljava/util/List;)V

    .line 69
    sget-object v6, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->HAS_ANNOTATIONS:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;
    ...
    const-string v7, "HAS_ANNOTATIONS.get(flags)"
    ...
    invoke-static/range {v8 .. v13}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->getAccessorFlags(ZLkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Visibility;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Modality;ZZZ)I

    move-result v6

    .line 75
    .local v6, "defaultAccessorFlags":I
    if-eqz v3, :cond_7
    ...
    invoke-virtual {v8, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    invoke-virtual {v9, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;

    move-result-object v9

    const-string v10, "IS_EXTERNAL_ACCESSOR.get(getterFlags)"
    ...
    invoke-virtual {v10, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    invoke-direct {v0, v11, v7, v12}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getAnnotations(Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;ILkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;

    move-result-object v11

    .line 81
    .local v11, "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    if-eqz v8, :cond_6
    ...
    check-cast v23, Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;
    ...
    invoke-virtual {v14, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;->get(I)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Modality;

    invoke-virtual {v13, v14}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoEnumFlags;->modality(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Modality;)Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;
    ...
    sget-object v14, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->VISIBILITY:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;

    invoke-virtual {v14, v7}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;->get(I)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Visibility;
    ...
    invoke-virtual {v12, v13}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertyGetterDescriptorImpl;->initialize(Lkotlin/reflect/jvm/internal/impl/types/KotlinType;)V

    .line 96
    nop

    .end local v7    # "getterFlags":I
    .end local v8    # "isNotDefault":Z
    .end local v9    # "isExternal":Z
    .end local v10    # "isInline":Z
    .end local v11    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .end local v12    # "getter":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertyGetterDescriptorImpl;
    goto :goto_6
    ...
    .line 101
    .local v7, "getter":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertyGetterDescriptorImpl;
    sget-object v8, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->HAS_SETTER:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;

    invoke-virtual {v8, v4}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;
    ...
    .line 103
    .local v8, "setterFlags":I
    :goto_7
    sget-object v9, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->IS_NOT_DEFAULT:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;
    ...
    const-string v10, "IS_NOT_DEFAULT.get(setterFlags)"
    ...
    .line 106
    .local v33, "isInline":Z
    move-object v11, v5

    check-cast v11, Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;

    sget-object v12, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;->PROPERTY_SETTER:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;

    invoke-direct {v0, v11, v8, v12}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getAnnotations(Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;ILkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;

    move-result-object v15

    .line 107
    .local v15, "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    if-eqz v9, :cond_9
    ...
    sget-object v13, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->MODALITY:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;

    invoke-virtual {v13, v8}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;->get(I)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Modality;

    invoke-virtual {v12, v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoEnumFlags;->modality(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Modality;)Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;
    ...
    sget-object v13, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->VISIBILITY:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$FlagField;
    ...
    invoke-static {v12, v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoEnumFlagsUtilsKt;->descriptorVisibility(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/ProtoEnumFlags;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Visibility;)Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;
    ...
    .local v24, "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    move-object/from16 v14, v16

    move-object/from16 v34, v15

    .end local v15    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .local v34, "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .line 119
    .local v11, "setterLocal":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    ...
    check-cast v14, Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;
    ...
    .line 119
    invoke-direct {v12, v13, v14, v15}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->valueParameters(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/protobuf/MessageLite;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotatedCallableKind;)Ljava/util/List;

    move-result-object v12

    .line 122
    .local v12, "valueParameters":Ljava/util/List;
    ...
    invoke-virtual {v2, v13}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertySetterDescriptorImpl;->initialize(Lkotlin/reflect/jvm/internal/impl/descriptors/ValueParameterDescriptor;)V

    .line 123
    move-object v14, v2

    .end local v2    # "setter":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertySetterDescriptorImpl;
    .end local v11    # "setterLocal":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .end local v12    # "valueParameters":Ljava/util/List;
    goto :goto_8

    .line 126
    .end local v24    # "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .end local v34    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .local v2, "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .restart local v15    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    :cond_9
    move-object/from16 v24, v2

    move-object/from16 v34, v15

    .end local v2    # "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .end local v15    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .restart local v24    # "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .restart local v34    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    move-object v2, v1
    ...
    invoke-virtual {v11}, Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations$Companion;->getEMPTY()Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .end local v8    # "setterFlags":I
    .end local v9    # "isNotDefault":Z
    .end local v10    # "isExternal":Z
    .end local v12    # "annotations":Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    .end local v33    # "isInline":Z
    goto :goto_8

    .line 131
    .end local v24    # "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    .restart local v2    # "local":Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/DeserializationContext;
    :cond_a
    move-object/from16 v24, v2
    ...
    .line 134
    .local v2, "setter":Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertySetterDescriptorImpl;
    sget-object v8, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags;->HAS_CONSTANT:Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;

    invoke-virtual {v8, v4}, Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/Flags$BooleanFlagField;->get(I)Ljava/lang/Boolean;

    move-result-object v8

    const-string v9, "HAS_CONSTANT.get(flags)"
    ...
    .line 135
    new-instance v8, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer$loadProperty$4;

    invoke-direct {v8, v0, v5, v1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer$loadProperty$4;-><init>(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;)V

    check-cast v8, Lkotlin/jvm/functions/Function0;

    invoke-virtual {v1, v8}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;->setCompileTimeInitializerFactory(Lkotlin/jvm/functions/Function0;)V
    ...
    invoke-interface {v8}, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;->getKind()Lkotlin/reflect/jvm/internal/impl/descriptors/ClassKind;
    ...
    .line 144
    new-instance v8, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer$loadProperty$5;

    invoke-direct {v8, v0, v5, v1}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer$loadProperty$5;-><init>(Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;)V
    ...
    invoke-direct {v0, v5, v10}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getPropertyFieldAnnotations(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Z)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    invoke-direct {v9, v10, v11}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FieldDescriptorImpl;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;)V

    check-cast v9, Lkotlin/reflect/jvm/internal/impl/descriptors/FieldDescriptor;

    .line 155
    new-instance v10, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FieldDescriptorImpl;

    const/4 v11, 0x1

    invoke-direct {v0, v5, v11}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->getPropertyFieldAnnotations(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Property;Z)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    invoke-direct {v10, v11, v12}, Lkotlin/reflect/jvm/internal/impl/descriptors/impl/FieldDescriptorImpl;-><init>(Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;Lkotlin/reflect/jvm/internal/impl/descriptors/PropertyDescriptor;)V

    check-cast v10, Lkotlin/reflect/jvm/internal/impl/descriptors/FieldDescriptor;

    .line 152
    invoke-virtual {v1, v7, v8, v9, v10}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedPropertyDescriptor;->initialize(Lkotlin/reflect/jvm/internal/impl/descriptors/impl/PropertyGetterDescriptorImpl;Lkotlin/reflect/jvm/internal/impl/descriptors/PropertySetterDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/FieldDescriptor;Lkotlin/reflect/jvm/internal/impl/descriptors/FieldDescriptor;)V
...
.method public final loadTypeAlias(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$TypeAlias;)Lkotlin/reflect/jvm/internal/impl/descriptors/TypeAliasDescriptor;
    ...
    .local v9, "it":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
    const/4 v10, 0x0

    .line 243
    .local v10, "$i$a$-map-MemberDeserializer$loadTypeAlias$annotations$1":I
    iget-object v11, v0, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/MemberDeserializer;->annotationDeserializer:Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotationDeserializer;
    ...
    invoke-virtual {v11, v9, v13}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/AnnotationDeserializer;->deserializeAnnotation(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;Lkotlin/reflect/jvm/internal/impl/metadata/deserialization/NameResolver;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/AnnotationDescriptor;

    move-result-object v9

    .line 396
    .end local v9    # "it":Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;
    .end local v10    # "$i$a$-map-MemberDeserializer$loadTypeAlias$annotations$1":I
    ...
    .line 247
    .local v14, "visibility":Lkotlin/reflect/jvm/internal/impl/descriptors/DescriptorVisibility;
    ...
    .line 253
    invoke-virtual {v1, v3, v4, v5}, Lkotlin/reflect/jvm/internal/impl/serialization/deserialization/descriptors/DeserializedTypeAliasDescriptor;->initialize(Ljava/util/List;Lkotlin/reflect/jvm/internal/impl/types/SimpleType;Lkotlin/reflect/jvm/internal/impl/types/SimpleType;)V
