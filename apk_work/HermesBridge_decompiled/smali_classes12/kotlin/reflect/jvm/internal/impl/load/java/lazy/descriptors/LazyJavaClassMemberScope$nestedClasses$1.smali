...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope$nestedClasses$1;->invoke(Lkotlin/reflect/jvm/internal/impl/name/Name;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
...
.method public final invoke(Lkotlin/reflect/jvm/internal/impl/name/Name;)Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
    ...
    invoke-virtual {v4, v7}, Lkotlin/reflect/jvm/internal/impl/name/ClassId;->createNestedClassId(Lkotlin/reflect/jvm/internal/impl/name/Name;)Lkotlin/reflect/jvm/internal/impl/name/ClassId;

    move-result-object v9

    const-string v4, "ownerDescriptor.classId!\u2026createNestedClassId(name)"
    ...
    .line 817
    invoke-interface {v1, v3}, Lkotlin/reflect/jvm/internal/impl/load/java/JavaClassFinder;->findClass(Lkotlin/reflect/jvm/internal/impl/load/java/JavaClassFinder$Request;)Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;
    ...
    .local v17, "it":Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;
    const/4 v3, 0x0

    .line 823
    .local v3, "$i$a$-let-LazyJavaClassMemberScope$nestedClasses$1$1":I
    ...
    .line 891
    .local v2, "p0":Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;
    const/4 v5, 0x0

    .line 824
    .local v5, "$i$a$-also-LazyJavaClassMemberScope$nestedClasses$1$1$1":I
    ...
    .line 822
    .end local v2    # "p0":Lkotlin/reflect/jvm/internal/impl/load/java/descriptors/JavaClassDescriptor;
    .end local v3    # "$i$a$-let-LazyJavaClassMemberScope$nestedClasses$1$1":I
    .end local v5    # "$i$a$-also-LazyJavaClassMemberScope$nestedClasses$1$1$1":I
    .end local v17    # "it":Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;
    move-object v2, v4
    ...
    .local v1, "$this$invoke_u24lambda_u242":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    ...
    .line 830
    .local v5, "$i$a$-with-LazyJavaClassMemberScope$nestedClasses$1$classes$1":I
    ...
    .line 891
    .local v8, "$this$invoke_u24lambda_u242_u24lambda_u241":Ljava/util/List;
    const/4 v9, 0x0

    .line 830
    .local v9, "$i$a$-buildList-LazyJavaClassMemberScope$nestedClasses$1$classes$1$1":I
    ...
    invoke-interface {v3, v1, v4, v7, v8}, Lkotlin/reflect/jvm/internal/impl/resolve/jvm/SyntheticJavaPartsProvider;->generateNestedClass(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;Lkotlin/reflect/jvm/internal/impl/name/Name;Ljava/util/List;)V

    .end local v8    # "$this$invoke_u24lambda_u242_u24lambda_u241":Ljava/util/List;
    .end local v9    # "$i$a$-buildList-LazyJavaClassMemberScope$nestedClasses$1$classes$1$1":I
    invoke-static {v6}, Lkotlin/collections/CollectionsKt;->build(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    .line 829
    .end local v1    # "$this$invoke_u24lambda_u242":Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    .end local v5    # "$i$a$-with-LazyJavaClassMemberScope$nestedClasses$1$classes$1":I
    move-object v1, v3
    ...
    .line 841
    .local v8, "field":Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaField;
    if-eqz v8, :cond_3
    ...
    .line 846
    .local v9, "enumMemberNames":Lkotlin/reflect/jvm/internal/impl/storage/NotNullLazyValue;
    iget-object v1, v0, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/descriptors/LazyJavaClassMemberScope$nestedClasses$1;->$c:Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;
    ...
    invoke-static {v3, v4}, Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaAnnotationsKt;->resolveAnnotations(Lkotlin/reflect/jvm/internal/impl/load/java/lazy/LazyJavaResolverContext;Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaAnnotationOwner;)Lkotlin/reflect/jvm/internal/impl/descriptors/annotations/Annotations;
    ...
    .end local v9    # "enumMemberNames":Lkotlin/reflect/jvm/internal/impl/storage/NotNullLazyValue;
    goto :goto_0
    ...
    .end local v8    # "field":Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaField;
    :goto_0
    check-cast v2, Lkotlin/reflect/jvm/internal/impl/descriptors/ClassDescriptor;
